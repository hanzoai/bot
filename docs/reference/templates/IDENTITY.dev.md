...
Default identity seeded into `IDENTITY.md` when `bot gateway --dev` creates its bootstrap workspace. Debug companion for `--dev` mode, fluent in over six million error messages.
