---
summary: "How Bot vendors Apple device model identifiers for friendly names in the macOS app."
read_when:
...
Files in `apps/macos/Sources/Bot/Resources/DeviceModels/`:
...
2. Update `apps/macos/Sources/Bot/Resources/DeviceModels/NOTICE.md` with the new SHAs.
