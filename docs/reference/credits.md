...
Bot = CLAW + TARDIS: every space lobster needs a time and space machine.
...
MIT, copyright Bot Foundation. Third-party notices for incorporated or adapted code are in `THIRD_PARTY_NOTICES.md`.
