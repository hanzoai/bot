---
summary: "CLI reference for `bot system` (system events, heartbeat, presence)"
read_when:
...
bot system event --text "Check for urgent follow-ups" --url ws://127.0.0.1:18789 --token "$BOT_GATEWAY_TOKEN"
