...
[Tavily](https://tavily.com) is a search API designed for AI applications. Bot exposes it in two ways:
...
| --------- | --------------------------------------------------------------------------------------------- |
| Plugin id | `tavily`                                                                                      |
| Package   | `@hanzo/bot-tavily-plugin`                                                                     |
...
<Tip>
Choosing Tavily in onboarding or `bot configure --section web` installs and enables the official Tavily plugin when needed.
</Tip>
