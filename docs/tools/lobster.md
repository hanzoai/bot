...
Install the Lobster CLI on the **same host** that runs the Hanzo Bot Gateway (see the [Lobster repo](https://github.com/bot/lobster)), and ensure `lobster` is on `PATH`.
