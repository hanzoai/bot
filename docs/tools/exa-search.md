      ...
      exa: {
        config: {
          webSearch: {
            ...
            baseUrl: "https://api.exa.ai", // optional; Bot appends /search
          },
        },
      },
    },
