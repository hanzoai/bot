...
read_when:
  - You maintain an Bot plugin
  - You see a plugin compatibility warning
  - You are planning a plugin SDK or manifest migration
---

Bot keeps older plugin contracts wired through named compatibility
...
Bot should not remove a documented plugin contract in the same release
...
- explicit channel target parsing and `bot/plugin-sdk/messaging-targets`
