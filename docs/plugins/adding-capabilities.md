---
summary: "Contributor guide for adding a new shared capability to the Bot plugin system"
read_when:
...
<Info>
  This is a **contributor guide** for Bot core developers. If you are
...
Use this when Bot needs a new shared domain such as embeddings, image
