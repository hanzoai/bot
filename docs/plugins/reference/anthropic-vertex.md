---
summary: "Bot Anthropic Vertex provider plugin for Claude models on Google Vertex AI."
read_when:
...
Bot Anthropic Vertex provider plugin for Claude models on Google Vertex AI.

## Distribution

- Package: `@hanzo/bot-anthropic-vertex-provider`
...
`/think off` or the native `/think xhigh|max` levels. Bot publishes its
