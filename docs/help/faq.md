...
- [Quick start and first-run setup]
  ...
  - [What's the recommended way to install and set up Hanzo Bot?](#whats-the-recommended-way-to-install-and-set-up-bot)
  ...
  - [Windows install says git not found or hanzo-bot not recognized](#windows-install-says-git-not-found-or-bot-not-recognized)
  - [The docs didn't answer my question - how do I get a better answer?](#the-docs-didnt-answer-my-question-how-do-i-get-a-better-answer)
  - [How do I install Hanzo Bot on Linux?](#how-do-i-install-bot-on-linux)
  - [How do I install Hanzo Bot on a VPS?](#how-do-i-install-bot-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask Hanzo Bot to update itself?](#can-i-ask-bot-to-update-itself)
  ...
  - [If I buy a Mac mini to run Hanzo Bot, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-bot-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different Hanzo Bot instances?](#can-multiple-people-use-one-whatsapp-number-with-different-bot-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What's the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run Hanzo Bot on a dedicated machine?](#how-important-is-it-to-run-bot-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run Hanzo Bot in a VM and what are the requirements](#can-i-run-bot-in-a-vm-and-what-are-the-requirements)
- [What is Hanzo Bot?](#what-is-bot)
  - [What is Hanzo Bot, in one paragraph?](#what-is-bot-in-one-paragraph)
  - [What's the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for Hanzo Bot](#what-are-the-top-five-everyday-use-cases-for-bot)
  - [Can Hanzo Bot help with lead gen outreach ads and blogs for a SaaS](#can-bot-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can Hanzo Bot run tasks on a schedule or continuously in the background?](#can-bot-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with Hanzo Bot saved locally?](#is-all-data-used-with-bot-saved-locally)
  - [Where does Hanzo Bot store its data?](#where-does-bot-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What's the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall Hanzo Bot?](#how-do-i-completely-uninstall-bot)
...
- [Config basics](#config-basics)
  ...
  - [Can the Hanzo Bot browser run headless?](#can-the-bot-browser-run-headless)
...
- [Remote gateways and nodes](#remote-gateways-and-nodes)
  ...
  - [Can two Hanzo Bot instances talk to each other (local + VPS)?](#can-two-bot-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does Hanzo Bot load environment variables?](#how-does-bot-load-environment-variables)
...
- [Sessions and multiple chats](#sessions-and-multiple-chats)
  ...
  - [Is there a way to make a team of Hanzo Bot instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-bot-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset Hanzo Bot but keep it installed?](#how-do-i-completely-reset-bot-but-keep-it-installed)
  ...
  - [Why doesn't Hanzo Bot reply in a group?](#why-doesnt-bot-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do Hanzo Bot, Flawd, and Krill use for models?](#what-do-bot-flawd-and-krill-use-for-models)
...
- [Gateway: ports, "already running", and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `hanzo-bot gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-bot-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `hanzo-bot gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-bot-gateway-status-show-config-cli-and-config-service-different)
  - [What does "another gateway instance is already listening" mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run Hanzo Bot in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-bot-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart Hanzo Bot?](#i-closed-my-terminal-on-windows-how-do-i-restart-bot)
  ...
  - [ELI5: `hanzo-bot gateway restart` vs `hanzo-bot gateway`](#eli5-bot-gateway-restart-vs-bot-gateway)
  - [What's the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media and attachments](#media-and-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose Hanzo Bot to inbound DMs?](#is-it-safe-to-expose-bot-to-inbound-dms)
...
[https://github.com/bot/bot/issues](https://github.com/bot/bot/issues)
[https://github.com/bot/bot/pulls](https://github.com/bot/bot/pulls)
...
[https://github.com/bot/bot/blob/main/CHANGELOG.md](https://github.com/bot/bot/blob/main/CHANGELOG.md)

Newest entries are at the top. If the top section is marked **Unreleased**, the next dated
section is the latest shipped version. Entries are grouped by **Highlights**, **Changes**, and
**Fixes** (plus docs/other sections when needed).

### I cant access docs.bot.ai SSL error What now
...
[https://github.com/bot/bot/tree/main/docs](https://github.com/bot/bot/tree/main/docs)
...
Yes. Add extra directories via `skills.load.extraDirs` in `~/.bot/bot.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.bot/skills` → bundled → `skills.load.extraDirs`. `hanzo-skills` installs into `./skills` by default, which Hanzo Bot treats as `<workspace>/skills`.
...
Use **Hanzo Skills** (CLI) or drop skills into your workspace. The macOS Skills UI isn't available on Linux.
Browse skills at [https://skills.hanzo.bot](https://skills.hanzo.bot).

Install the Hanzo Skills CLI (pick one package manager):
...
Hanzo Skills installs into `./skills` under your current directory (or falls back to your configured Hanzo Bot workspace); Hanzo Bot treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.bot/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [Hanzo Skills](/tools/hanzo-skills).
...
Hanzo Bot reads an optional **JSON5** config from `$BOT_CONFIG_PATH` (default: `~/.bot/bot.json`):
...
Still stuck? Ask in [Discord](https://discord.com/invite/hanzo) or open a [GitHub discussion](https://github.com/bot/bot/discussions).
