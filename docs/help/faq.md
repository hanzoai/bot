...
- [Quick start and first-run setup]
  ...
  - [What's the recommended way to install and set up HanzoBot?](#whats-the-recommended-way-to-install-and-set-up-hanzobot)
  ...
  - [How do I install HanzoBot on Linux?](#how-do-i-install-hanzobot-on-linux)
  - [How do I install HanzoBot on a VPS?](#how-do-i-install-hanzobot-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask HanzoBot to update itself?](#can-i-ask-hanzobot-to-update-itself)
  ...
  - [If I buy a Mac mini to run HanzoBot, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-hanzobot-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different HanzoBot instances?](#can-multiple-people-use-one-whatsapp-number-with-different-hanzobot-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What's the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run HanzoBot on a dedicated machine?](#how-important-is-it-to-run-hanzobot-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run HanzoBot in a VM and what are the requirements](#can-i-run-hanzobot-in-a-vm-and-what-are-the-requirements)
- [What is HanzoBot?](#what-is-hanzobot)
  - [What is HanzoBot, in one paragraph?](#what-is-hanzobot-in-one-paragraph)
  - [What's the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for HanzoBot](#what-are-the-top-five-everyday-use-cases-for-hanzobot)
  - [Can HanzoBot help with lead gen outreach ads and blogs for a SaaS](#can-hanzobot-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can HanzoBot run tasks on a schedule or continuously in the background?](#can-hanzobot-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with HanzoBot saved locally?](#is-all-data-used-with-hanzobot-saved-locally)
  - [Where does HanzoBot store its data?](#where-does-hanzobot-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What's the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall HanzoBot?](#how-do-i-completely-uninstall-hanzobot)
...
- [Config basics](#config-basics)
  ...
  - [Can the HanzoBot browser run headless?](#can-the-hanzobot-browser-run-headless)
...
- [Remote gateways and nodes](#remote-gateways-and-nodes)
  ...
  - [Can two HanzoBot instances talk to each other (local + VPS)?](#can-two-hanzobot-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does HanzoBot load environment variables?](#how-does-hanzobot-load-environment-variables)
...
- [Sessions and multiple chats](#sessions-and-multiple-chats)
  ...
  - [Is there a way to make a team of HanzoBot instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-hanzobot-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset HanzoBot but keep it installed?](#how-do-i-completely-reset-hanzobot-but-keep-it-installed)
  ...
  - [Why doesn't HanzoBot reply in a group?](#why-doesnt-hanzobot-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do HanzoBot, Flawd, and Krill use for models?](#what-do-hanzobot-flawd-and-krill-use-for-models)
...
- [Gateway: ports, "already running", and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [How do I run HanzoBot in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-hanzobot-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart HanzoBot?](#i-closed-my-terminal-on-windows-how-do-i-restart-hanzobot)
...
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose HanzoBot to inbound DMs?](#is-it-safe-to-expose-hanzobot-to-inbound-dms)
...
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-hanzobot-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.
