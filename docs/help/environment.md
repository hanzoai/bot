...
| Variable          | Purpose                                                                                                                                                                     |
| ----------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `BOT_HOME`        | Override the home directory used for all internal path resolution (`~/.bot/`, agent dirs, sessions, credentials). Useful when running HanzoBot as a dedicated service user. |
