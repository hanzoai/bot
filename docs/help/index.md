...
- [Doctor](/gateway/doctor) - `bot doctor`: health checks, config migrations, repair steps
...
- [Environment variables](/help/environment) - where Bot loads env vars and precedence
