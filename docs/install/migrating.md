---
summary: "Move (migrate) a Hanzo Bot install from one machine to another"
read_when:
...
This guide migrates a Hanzo Bot Gateway from one machine to another **without redoing onboarding**.
...
- [Where does Hanzo Bot store its data?](/help/faq#where-does-bot-store-its-data)
