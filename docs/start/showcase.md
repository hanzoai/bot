...
<Info>
**Want to be featured?** Share your project in [#showcase on Discord](https://discord.gg/clawd) or [tag @hanzo-bot on X](https://x.com/bot).
</Info>
...
A scheduled prompt generates a single "scene" image each morning (weather, tasks, date, favorite post/quote) via a Hanzo Bot persona.
</Card>
...
<Steps>
  <Step title="Share It">
    Post in [#showcase on Discord](https://discord.gg/clawd) or [tweet @bot](https://x.com/bot)
  </Step>
