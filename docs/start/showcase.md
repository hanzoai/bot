---
summary: "Community-built projects and integrations powered by Bot"
title: "Showcase"
description: "Real-world Bot projects from the community"
read_when:
  - Looking for real Bot usage examples
  - Updating community project highlights
---

Community-built Bot projects: PR review loops, mobile apps, home automation, voice systems, devtools, and memory workflows, built chat-native on Telegram, WhatsApp, Discord, and terminals.

<Info>
**Want to be featured?** Share your project in [#self-promotion on Discord](https://discord.gg/clawd) or [tag @bot on X](https://x.com/bot).
</Info>
...
Keeps Bot usable on 2-4 GB machines: checks free memory and trims heavy features before the box starts swapping. [Source on GitHub](https://github.com/mirajmahmudul/bot-lite-mode).
</Card>

<Card title="tokenomics cost tracker" icon="coins" href="https://github.com/ncz-os/tokenomics">
  **@ncz-os** • `devtools` `costs` `tokens`

Token cost tracker from an NVIDIA engineer with first-class Bot support: see exactly where your agent spend goes, per model and per session.
</Card>
...
Had Bot build its own Google Analytics query tool, then packaged and published it to ClawHub.
</Card>
...
OpenCode finishes the change, opens a PR, Bot reviews the diff and replies in Telegram with suggestions plus a clear merge verdict.
...
Asked "Robby" (@bot) for a local wine cellar skill. It requests a sample CSV export and a store path, then builds and tests the skill (962 bottles in the example).
...
Desktop app to manage skills and commands across Agents, Claude, Codex, and Bot.
...
Upload to Cloudflare R2/S3 and generate secure presigned download links. Useful for remote Bot instances.
...
CLI for Linear that integrates with agentic workflows (Claude Code, Bot). Manage issues, projects, and workflows from the terminal.
</Card>
...
A scheduled prompt generates one scene image each morning (weather, tasks, date, favorite post or quote) via an Bot persona.
</Card>
...
Bot connected to Jira, then generated a new skill on the fly (before it existed on ClawHub).
</Card>
...
Set Bot loose on car dealers: it handled the back-and-forth negotiation and knocked $4,200 off the price.
</Card>
...
<Card title="Obsidian second brain" icon="book" href="https://notesbylex.com/bot-the-missing-piece-for-obsidians-second-brain">
...
One tap on a Pebble Ring starts a voice conversation with Bot — agent access from a wearable.
</Card>
...
iPhone Action Button wired to Bot: press, talk, and the agent talks back like a walkie-talkie.
</Card>

<Card title="Clawdia phone bridge" icon="phone" href="https://github.com/alejandroOPI/clawdia-bridge">
  **@alejandroOPI** • `voice` `vapi` `bridge`

Vapi voice assistant to Bot HTTP bridge. Near real-time phone calls with your agent.
</Card>
...
Packaging, deployment, and integrations that make Bot easier to run and extend.
...
<Card title="Home Assistant skill" icon="toggle-on" href="https://clawhub.ai/homeofe/skills/bot-homeassistant">
...
The physical-world side of Bot: homes, sensors, cameras, vacuums, and other devices.
...
Bot found the HomePods on the local network and wrote itself a skill to control them.
</Card>
...
Nix-native home automation with Bot as the interface, plus Grafana dashboards.
...
Full astronomy gear marketplace. Built with and around the Bot ecosystem.
</Card>
...
<Steps>
  <Step title="Share it">
    Post in [#self-promotion on Discord](https://discord.gg/clawd) or [tweet @bot](https://x.com/bot).
  </Step>
...
- [Bot](/start/bot)
- [Full X showcase on bot.ai](https://bot.ai/showcase/)
