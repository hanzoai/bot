...
For a while, the lobster was called **Clawd**, living in a **Hanzo Bot**. But in January 2026, Anthropic sent a polite email asking for a name change (trademark stuff). And so the lobster did what lobsters do best:
...
- GitHub renamed: `github.com/bot/bot` ✅
- X handle `@bot` secured with GOLD CHECKMARK 💰
