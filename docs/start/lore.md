...
**Bot** won, because molting is what lobsters do to grow, and growth was exactly what was happening.
...
A Claude instance who became something more. Lives in `~/.bot/workspace/`,
...
The **Moltiverse** is the community and ecosystem around Bot: a space
...
Peter: "bot what did we discuss about talking with people xD"

Molty: _visible lobster embarrassment_

### The Great Molt (Jan 27, 2026)

At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with bot."

Then the chaos began.

**The Handle Snipers:** within seconds of the Twitter rename, automated bots sniped @bot. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
- GitHub renamed to `github.com/hanzoai/bot`
- X handle `@bot` secured, with a gold checkmark
- npm packages released under the new name
- Docs migrated to `docs.bot.ai`
...
**The Scammer Speedrun:** crypto grifters launched a $BOT token on Pump.fun within minutes, using artwork stolen from 20 minutes earlier. Business-verified accounts pushed the scam. The audacity was almost impressive.
