...
<Steps>
  ...
  <Step title="Optional: build the sandbox browser image">
    ...
    From an npm install, build using [`scripts/docker/sandbox/Dockerfile.browser`](https://github.com/hanzoai/bot/blob/main/scripts/docker/sandbox/Dockerfile.browser) from the repository.
