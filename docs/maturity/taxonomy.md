...
summary: "Detailed reference for the product areas and checks behind the Bot maturity scorecard."
---
...
<Tabs>
  <Tab title="Core">
    ...
    <a className="maturity-surface-link" href="#bot-app-sdk">
      <span className="maturity-surface-title">Bot App SDK</span>
...
<AccordionGroup>
  ...
  <Accordion title="Bot App SDK - M2 Alpha - 6 areas">
    <a id="bot-app-sdk" />

    Bot App SDK is a distinct external app contract separate from Gateway runtime and Plugin SDK. Current scoring shows a real `@hanzo/bot-sdk` path with gaps around public packaging, auto-discovery, approvals, helpers, and compatibility.
    ...
    [Bot Sdk](/gateway/external-apps), [Bot Sdk Api Design](/gateway/external-apps)
    ...
    [Bot Sdk](/gateway/external-apps), [Bot Sdk Api Design](/gateway/external-apps), [Protocol](/gateway/protocol), [Index](/gateway/security/index)
    ...
    [Bot Sdk](/gateway/external-apps), [Bot Sdk Api Design](/gateway/external-apps), [Protocol](/gateway/protocol)
    ...
    [Bot Sdk Api Design](/gateway/external-apps), [Typebox](/concepts/typebox), [Protocol](/gateway/protocol)
...
<AccordionGroup>
  ...
  <Accordion title="Linux companion app - M0 Planned - 5 areas">
    ...
    [Linux](/platforms/linux), [Bot](/start/bot), [Doctor](/gateway/doctor)
