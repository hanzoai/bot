...
`bot models auth login-github-copilot` shortcut, token refresh, embeddings,
...
<AccordionGroup>
  ...
  <Accordion title="Request compatibility">
    Bot sends Copilot IDE-style request headers on Copilot transports
  ...
  <Accordion title="Token storage">
    ...
    token when Bot runs. You do not need to manage the token manually.
  </Accordion>
</AccordionGroup>
