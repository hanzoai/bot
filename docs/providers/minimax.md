---
summary: "Use MiniMax M2.1 in Hanzo Bot"
read_when:
...
See [MiniMax OAuth plugin README](https://github.com/hanzoai/bot/tree/main/extensions/minimax-portal-auth) for details.
...
- Use `hanzo-bot models list` and `hanzo-bot models set minimax/MiniMax-M2.1` to switch.
...
- Running `hanzo-bot configure` and selecting **MiniMax M2.1**, or
