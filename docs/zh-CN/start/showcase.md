...
<Info>
**想要展示你的项目？** 在 [Discord 的 #showcase 频道](https://discord.gg/clawd) 分享或在 [X 上 @bot](https://x.com/bot)。
</Info>
...
向"Robby"（@bot）请求一个本地酒窖 skill。它请求一个示例 CSV 导出 + 存储位置，然后快速构建/测试该 skill（示例中有 962 瓶酒）。
...
<Card title="Home Assistant 插件" icon="home" href="https://github.com/ngutman/bot-ha-addon">
...
<Steps>
  <Step title="分享它">
    在 [Discord 的 #showcase 频道](https://discord.gg/clawd) 发布或在 [Twitter 上 @bot](https://x.com/bot)
  </Step>
  <Step title="包含详细信息">
