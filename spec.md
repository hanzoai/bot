...
canonical reference is [`hanzoai/bot/extensions/memory/index.ts`](
https://github.com/hanzoai/bot/blob/main/extensions/memory/index.ts).
Schema (pages / edges / facts / FTS5) is in
[`extensions/memory/sqlite.ts`](
https://github.com/hanzoai/bot/blob/main/extensions/memory/sqlite.ts).
...
- The regex set in [graph-links/index.ts](
  https://github.com/hanzoai/bot/blob/main/extensions/graph-links/index.ts)
...
YAML schema is documented in [`recipes-brain/recipes/email.yaml`](
https://github.com/hanzoai/bot/blob/main/extensions/recipes-brain/recipes/email.yaml)
