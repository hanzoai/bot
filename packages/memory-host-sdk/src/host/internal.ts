...
import { normalizeStringEntries, uniqueStrings } from "@hanzo/bot-normalization-core";
...
function shouldDescendMemoryEntry(
  ...
  return entry.kind === "directory" && entry.name !== ".bot-repair";
}
