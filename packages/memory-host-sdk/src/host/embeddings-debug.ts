...
const debugEmbeddings = isTruthyEnvValue(process.env.BOT_DEBUG_MEMORY_EMBEDDINGS);

/** Write embedding debug metadata when BOT_DEBUG_MEMORY_EMBEDDINGS is enabled. */
