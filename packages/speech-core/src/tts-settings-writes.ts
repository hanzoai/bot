...
import type { TtsAutoMode, TtsProvider } from "bot/plugin-sdk/config-contracts";
import { privateFileStoreSync } from "bot/plugin-sdk/security-runtime";
import { canonicalizeSpeechProviderId } from "bot/plugin-sdk/speech-core";
