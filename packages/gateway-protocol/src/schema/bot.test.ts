...
describe("Bot chat params protocol", () => {
...
describe("Bot chat question protocol", () => {
  const question = {
...
describe("Bot chat history protocol", () => {
...
describe("Bot setup detection protocol", () => {
...
describe("Bot setup verification protocol", () => {
