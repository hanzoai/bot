// Gateway Protocol schema module defines Bot chat payloads.
...
/**
 * Bot chat lets clients (macOS app onboarding, future UIs) hold the
...
/** One Bot reply; `action` tells clients about conversation handoffs. */
