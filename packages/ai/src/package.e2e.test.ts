...
const compatibility = {
  ...
  "@hanzo/bot-ai/internal/anthropic": {
    values: [
      "streamAnthropic",
...
describe("@hanzo/bot-ai packed package", () => {
  it("installs externally and preserves every published compatibility export", async () => {
    ...
    const tempDir = tempDirs.make("bot-ai-consumer-");
