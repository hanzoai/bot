...
- **BREAKING:** Reject invalid/unknown config entries and refuse to start the gateway for safety. Run `hanzo-bot doctor --fix` to repair, then update plugins (`openclaw plugins update`) if you use any.
