---
name: healthcheck
description: "Audit/harden Bot hosts: SSH, firewall, updates, exposure, backups, disk encryption, gateway security."
---

# Bot host healthcheck
...
- Never claim Bot manages OS firewall, SSH, or updates.
...
- Add scheduled `bot security audit --deep`.
