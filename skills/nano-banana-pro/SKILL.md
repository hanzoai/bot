...
- Or set `skills."nano-banana-pro".apiKey` / `skills."nano-banana-pro".env.GEMINI_API_KEY` in `~/.hanzo/bot/bot.json`
...
- The script prints a `MEDIA:` line for Hanzo Bot to auto-attach on supported chat providers.
