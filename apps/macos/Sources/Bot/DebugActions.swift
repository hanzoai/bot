...
enum DebugActions {
    private static let verboseDefaultsKey = "bot.debug.verboseMain"
    private static let onboardingSeenKey = "bot.onboardingSeen"
    ...
    static func sendTestNotification() async {
        _ = await NotificationManager().send(title: "Bot", body: "Test notification", sound: nil)
    }
    ...
    private static func resolveSessionStorePath() -> String {
        ...
        let configURL = BotPaths.configURL
        guard
