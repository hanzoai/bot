...
final class QuickChatReplyBinding {
    typealias ViewModelFactory = @MainActor (QuickChatRoutingTarget) -> BotChatViewModel

    private(set) var route: QuickChatRoutingTarget?
    private(set) var viewModel: BotChatViewModel?
    ...
    private static func makeViewModel(route: QuickChatRoutingTarget) -> BotChatViewModel {
