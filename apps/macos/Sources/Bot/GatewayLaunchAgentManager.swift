...
enum GatewayLaunchAgentManager {
    ...
    private static let logger = Logger(subsystem: "ai.bot", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".bot/disable-launchagent"
    ...
    private static var generatedEnvironmentDirectoryURL: URL {
        BotPaths.stateDirURL.appendingPathComponent("service-env", isDirectory: true)
    }
...
extension GatewayLaunchAgentManager {
    ...
    private static func gatewayPort(from service: [String: Any]) -> Int? {
        ...
        return self.validGatewayPort(environment?["BOT_GATEWAY_PORT"] as? String)
    }
