...
private let dashboardManagerLogger = Logger(subsystem: "ai.bot", category: "DashboardManager")
...
extension DashboardManager {
        ...
        -> DashboardManager
    {
        let manager = DashboardManager(
            ...
            mainWindowAutosaveName: "BotDashboardWindow-Test-\(UUID().uuidString)")
