...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.hanzo.bot", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other HanzoBot windows, but below the system’s pop-up menus.
