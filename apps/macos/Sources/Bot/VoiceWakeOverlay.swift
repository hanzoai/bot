...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.bot", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Bot windows, but below the system’s pop-up menus.
