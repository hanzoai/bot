...
actor MacNodeRuntime {
    ...
    func handleInvoke(_ req: BridgeInvokeRequest) async -> BridgeInvokeResponse {
        ...
        do {
            ...
            case BotComputerCommand.act.rawValue:
...
extension MacNodeRuntime {
    ...
    private func handleComputerActInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        ...
        do {
            params = try Self.decodeParams(BotComputerActParams.self, from: req.paramsJSON)
        } catch {
            return Self.errorResponse(
                req,
                code: .invalidRequest,
        ...
        do {
            ...
            case .accessibilityNotTrusted:
                return Self.errorResponse(
                    req,
                    code: .unavailable,
                    message: "ACCESSIBILITY_REQUIRED: grant Accessibility permission to Bot")
            ...
            case .postEventAccessDenied:
                return Self.errorResponse(
                    req,
                    code: .unavailable,
                    message: "POST_EVENT_REQUIRED: macOS denied Event Posting access; re-grant Bot "
