...
final class ExecApprovalsGatewayPrompter {
    ...
    private let logger = Logger(subsystem: "ai.bot", category: "exec-approvals.gateway")
    ...
    private func handle(push: GatewayPush) async {
        ...
        guard evt.event == "exec.approval.requested" || evt.event == "bot.approval.requested" else { return }
        ...
        do {
            ...
            if evt.event == "bot.approval.requested" {
