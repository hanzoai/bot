...
let dashboardWindowLogger = Logger(subsystem: "ai.bot", category: "DashboardWindow")
...
enum DashboardWindowLayout {
    ...
    static let linkBrowserWidthDefaultsKey = "BotDashboardLinkBrowserWidth"
    static let windowFrameAutosaveName = "BotDashboardWindow"
...
enum DashboardNativeCommand: String {
    case newSession = "bot:native-new-session"
    case commandPalette = "bot:native-toggle-search"
    ...
    var legacyFallbackEventName: String? {
        switch self {
        case .newSession: nil
        case .commandPalette: "bot:native-open-search"
        }
    }
}
