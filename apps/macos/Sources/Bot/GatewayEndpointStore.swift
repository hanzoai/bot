...
actor GatewayEndpointStore {
    ...
    private static let staticLogger = Logger(subsystem: "ai.bot", category: "gateway-endpoint")
    ...
    private let logger = Logger(subsystem: "ai.bot", category: "gateway-endpoint")
...
extension GatewayEndpointStore {
    ...
    {
        if let raw = env["BOT_GATEWAY_PORT"],
