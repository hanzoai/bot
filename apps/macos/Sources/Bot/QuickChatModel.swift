...
final class QuickChatModel {
    private struct RetryIdentity {
        ...
        let sessionKey: String
        let agentID: String?
        let attachments: [BotChatAttachmentPayload]
    ...
    typealias SendProvider = @MainActor (
        ...
        String?,
        String,
        [BotChatAttachmentPayload]) async throws -> String
    ...
    typealias ModelPatchProvider = @MainActor (
        ...
        String?) async throws -> BotChatModelPatchResult?
    ...
    private(set) var modelChoices: [BotChatModelChoice] = []
    ...
    @ObservationIgnored private var modelPatchTask: Task<BotChatModelPatchResult?, Error>?
    ...
    func selectModel(_ selectionID: String) {
        ...
        guard normalized == BotChatViewModel.defaultModelSelectionID ||
...
extension QuickChatModel {
    ...
    private func finishModelPatch(
        _ task: Task<BotChatModelPatchResult?, Error>,
        requestID: UUID,
        ...
        selectionID: String?) async -> Bool
    {
        do {
            ...
            if self.routingTarget == target {
                ...
                } else if selectionID != BotChatViewModel.defaultModelSelectionID {
