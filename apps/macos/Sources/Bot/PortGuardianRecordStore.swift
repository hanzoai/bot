...
/// This intentionally ignores BOT_STATE_DIR: prod, dev, and profile-specific
...
final class PortGuardianRecordStore: @unchecked Sendable {
    ...
    private let database: BotNativeStateSQLite
        ...
        }) throws
    {
        ...
        let database: BotNativeStateSQLite
        do {
            database = try BotNativeStateSQLite(databaseURL: databaseURL)
        } catch {
    ...
    private static func decodeRecord(
        _ statement: BotNativeStateSQLiteStatement) throws -> PortGuardian.Record
    {
    ...
    private static func bind(
        ...
        to statement: BotNativeStateSQLiteStatement) throws
    {
    ...
    private static func storeError(_ error: Error) -> Error {
        ...
        if let error = error as? BotNativeStateError {
