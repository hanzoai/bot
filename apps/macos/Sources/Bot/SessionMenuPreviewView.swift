...
enum SessionMenuPreviewLoader {
    private static let logger = Logger(subsystem: "ai.bot", category: "SessionPreview")
    ...
    private static func requestPreview(
        keys: [String],
        maxItems: Int) async throws -> BotSessionsPreviewPayload
    {
    ...
    private static func snapshot(
        from entry: BotSessionPreviewEntry,
    ...
    private static func cache(payload: BotSessionsPreviewPayload, maxItems: Int) async {
    ...
    private static func previewItems(
        from payload: BotChatHistoryPayload,
        maxItems: Int) -> [SessionPreviewItem]
    {
        let boundedItems = self.normalizeMaxItems(maxItems)
    ...
    private static func decodeMessages(_ raw: [BotKit.AnyCodable]) -> [BotChatMessage] {
    ...
    private static func previewText(for message: BotChatMessage) -> String? {
    ...
    private static func isToolCall(_ message: BotChatMessage) -> Bool {
    ...
    private static func toolNames(for message: BotChatMessage) -> [String] {
        var names: [String] = []
    ...
    private static func mediaSummary(for message: BotChatMessage) -> String? {
