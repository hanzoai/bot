...
final class HealthStore {
    ...
    private static let logger = Logger(subsystem: "ai.hanzo.bot", category: "health")
    ...
    var detailLine: String? {
        if let error = self.lastError, !error.isEmpty {
            ...
            if lower.contains("connection refused") {
                ...
                return "The gateway control port (\(host)) isn’t listening — restart HanzoBot to bring it back."
            }
