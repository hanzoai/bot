...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/hanzo-bot/hanzo-bot") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/hanzo-bot/hanzo-bot")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://hanzo-bot.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "HanzoBotBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "HanzoBotBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "HanzoBotGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "HanzoBotGitCommit") as? String) ??
            "unknown"
    }
