...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            // Hero treatment from bot.ai: coral silhouette glow at 10% of
            ...
            BotMascotView(interactive: true)
                .frame(width: 160, height: 160)
                .shadow(
                    color: BotMascotView.heroGlowColor(
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(icon: "globe", title: "Website", url: "https://bot.ai")
                AboutLinkRow(icon: "book", title: "Docs", url: "https://docs.bot.ai")
                AboutLinkRow(
