...
enum QuickChatModelMenuPresenter {
    static func present(model: QuickChatModel, panel: NSPanel, contentView: NSView) {
        ...
        defaultItem.representedObject = BotChatViewModel.defaultModelSelectionID
        defaultItem.state = model.selectedModelSelectionID == BotChatViewModel.defaultModelSelectionID
            ? .on
            : .off
