...
struct GeneralSettings: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .botPermissionsChanged)) { _ in
            self.refreshComputerControlPermissions()
        }
    ...
    private var generalPage: some View {
        VStack(alignment: .leading, spacing: 20) {
            SettingsPageHeader(
                title: "General",
                subtitle: "Everyday Bot app behavior.")
            ...
            SettingsCardGroup("App") {
                SettingsCardToggleRow(
                    ...
                    subtitle: self.state.bundleLocationAllowsPersistentIntegration
                        ? "Automatically start Bot after you sign in."
                        : "Move Bot to Applications before enabling launch at login.",
                ...
                SettingsCardToggleRow(
                    ...
                    subtitle: """
                    Keep Bot visible in the Dock. When off, windows still show the Dock icon while open.
                    """,
    ...
    private var botStatusPanel: some View {
        HStack(alignment: .center, spacing: 14) {
            ...
            VStack(alignment: .leading, spacing: 4) {
                Text(self.state.isPaused ? "Bot paused" : "Bot active")
                    .font(.headline)
            ...
            Toggle("Bot active", isOn: self.activeBinding)
                .labelsHidden()
                .toggleStyle(.switch)
        }
    ...
    private var connectionStatusSubtitle: String {
        switch self.state.connectionMode {
        case .local:
            return "Bot starts and monitors the Gateway on this Mac."
        case .remote:
        ...
        SettingsCardGroup("Advanced") {
            DisclosureGroup(isExpanded: self.$showRemoteAdvanced) {
                VStack(alignment: .leading, spacing: 12) {
                    ...
                    self.advancedTextField(
                        "Project root",
                        placeholder: "/home/you/Projects/bot",
                        text: self.$state.remoteProjectRoot)
                    self.advancedTextField(
                        "CLI path",
                        placeholder: "/Applications/Bot.app/.../bot",
