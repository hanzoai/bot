...
enum RuntimeLocator {
    private static let logger = Logger(subsystem: "ai.bot", category: "runtime")
    ...
    static func describeFailure(_ error: RuntimeResolutionError) -> String {
        ...
        case let .notFound(searchPaths):
            [
                "bot needs Node \(self.supportedNodeRange) but found no runtime.",
