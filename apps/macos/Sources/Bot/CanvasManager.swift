...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.hanzo.bot", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("HanzoBot/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__hanzo-bot__/a2ui/").absoluteString + "?platform=macos"
    }
