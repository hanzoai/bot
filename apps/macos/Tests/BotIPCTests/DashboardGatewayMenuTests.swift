...
struct DashboardGatewayMenuTests {
    @Test func `connection label names primary only for multiple gateways`() {
        ...
        let cases: [(AppState.ConnectionMode, [DashboardGatewayEntry], String)] = [
            (.unconfigured, [primary], "Bot Not Configured"),
            (.unconfigured, [primary, profile], "Bot Not Configured — Mac Studio"),
            (.local, [primary], "Bot Active"),
            (.local, [primary, profile], "Bot Active — Mac Studio"),
            (.remote, [primary], "Remote Bot Active"),
            (.remote, [primary, profile], "Remote Bot Active — Mac Studio"),
        ]
