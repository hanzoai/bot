...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = HanzoBotLocationMode.off.rawValue
            ...
            Form {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        Text("Keeps the screen awake while HanzoBot is open.")
                            .font(.footnote)
                            .foregroundStyle(.secondary)
                    }
    ...
    private var locationMode: HanzoBotLocationMode {
        HanzoBotLocationMode(rawValue: self.locationEnabledModeRaw) ?? .off
    }
