...
Maintenance update for the current Bot release.
...
Bot is now available on iPhone.

Connect to your Bot Gateway to chat with your assistant, use realtime Talk mode, review approvals, share content from iOS, and bring device capabilities like camera, location, screen, and notifications into your private automation workflows.
...
Maintenance update for the current Bot development release.
...
First App Store release of Bot for iPhone. Pair with your Bot Gateway to use chat, voice, sharing, and device actions from iOS.
