...
internal const val extraWearLaunchTarget = "bot.wear.launchTarget"
...
internal fun BotWearApp(
  ...
  BotWearTheme(themeMode = themeMode) {
    AppScaffold {
      BotWearScreens(
        snapshot = snapshot,
        failure = failure,
        ...
        onTalk = {
          if (!state.connected || snapshot?.activeSessionId == null) return@BotWearScreens
...
internal const val REPLY_RESULT_KEY = "bot_watch_message"
