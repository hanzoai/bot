...
internal const val extraWearScreenshotMode = "bot.screenshotMode"
internal const val extraWearScreenshotScene = "bot.screenshotScene"
...
@Composable
internal fun BotWearScreenshotApp(scene: WearScreenshotScene) {
  BotWearTheme(themeMode = WearThemeMode.Dark) {
    AppScaffold {
      BotWearScreens(
