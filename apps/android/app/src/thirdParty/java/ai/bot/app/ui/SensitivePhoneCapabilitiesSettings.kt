...
import ai.bot.app.accessibility.AccessibilityComponentController
  ...
  AlertDialog(
    ...
    text = {
      Column(verticalArrangement = Arrangement.spacedBy(10.dp)) {
        Text(
          nativeString(
            "Enabling lets Bot observe and control other apps' screens when armed. Android accessibility access is required.",
          ),
        )
      }
    },
