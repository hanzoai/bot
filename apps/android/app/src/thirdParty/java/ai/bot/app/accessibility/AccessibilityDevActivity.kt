...
class AccessibilityDevActivity : AppCompatActivity() {
  ...
  private fun refreshForegroundPackage() {
    foregroundPackageName = BotAccessibilityService.instance?.foregroundPackageName()
  }
...
private fun AccessibilityDevScreen(
  ...
  val serviceConnection by BotAccessibilityService.connection.collectAsState()
