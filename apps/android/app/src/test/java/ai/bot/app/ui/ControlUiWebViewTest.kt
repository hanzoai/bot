  ...
  fun pinnedSslError_proceedsOnlyForExactCertificateAtGatewayOrigin() {
    ...
    assertTrue(
      shouldProceedForPinnedControlUiSslError(
        pageBaseUrl = "https://gateway.example.com:8443/bot/",
        expectedFingerprint = fingerprint,
        errorUrl = "https://gateway.example.com:8443/bot/assets/app.js",
    ...
    assertFalse(
      shouldProceedForPinnedControlUiSslError(
        pageBaseUrl = "https://gateway.example.com:8443/bot/",
        expectedFingerprint = fingerprint,
        errorUrl = "https://attacker.example.com:8443/bot/assets/app.js",
        encodedCertificate = certificate,
      ),
    )
    assertFalse(
