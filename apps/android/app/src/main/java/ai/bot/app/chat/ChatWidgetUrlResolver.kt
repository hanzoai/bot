...
internal object ChatWidgetUrlResolver {
  private const val DOCUMENTS_PATH = "/__bot__/canvas/documents"
  ...
  private fun parseCapabilitySurface(raw: String?): URI? {
    ...
    if (segments.size < 3 || segments[segments.lastIndex - 2] != "__bot__" || segments[segments.lastIndex - 1] != "cap") return null
