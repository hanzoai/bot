...
enum class GatewayMethod(
  ...
  BotChat("bot.chat"),
  BotChatHistory("bot.chat.history"),
  BotChangesList("bot.changes.list"),
  BotApprovalList("bot.approval.list"),
  BotSetupDetect("bot.setup.detect"),
  BotSetupActivate("bot.setup.activate"),
  BotSetupAuthStart("bot.setup.auth.start"),
  BotSetupPrepareStart("bot.setup.prepare.start"),
  ...
  BotSetupVerify("bot.setup.verify"),
...
enum class GatewayEvent(
  ...
  BotApprovalRequested("bot.approval.requested"),
  BotApprovalResolved("bot.approval.resolved"),
