...
import ai.bot.app.node.CanvasNavigationPolicy
...
internal class CanvasHostView(
  ...
  private fun createWebView(): WebView =
    WebView(context).also { webView ->
      ...
      if (isDebuggable) {
        Log.d("BotWebView", "userAgent: ${webSettings.userAgentString}")
      }
      ...
      webView.webViewClient =
        object : WebViewClient() {
          ...
          override fun onReceivedError(
            ...
            Log.e("BotWebView", "onReceivedError: ${error.errorCode} ${error.description} ${request.url}")
          }
          ...
          override fun onPageFinished(
            ...
            currentPageUrlRef.set(url)
            if (isDebuggable) {
              Log.d("BotWebView", "onPageFinished: $url")
            }
      ...
      if (WebViewFeature.isFeatureSupported(WebViewFeature.WEB_MESSAGE_LISTENER)) {
        ...
        Log.w("BotWebView", "WebMessageListener unsupported; canvas actions disabled")
      }
      addView(
        webView,
