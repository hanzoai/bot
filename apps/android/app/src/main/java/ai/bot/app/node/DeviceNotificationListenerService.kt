...
import ai.bot.app.NotificationBurstLimiter
import ai.bot.app.SecurePrefs
import ai.bot.app.allowsPackage
import ai.bot.app.isWithinQuietHours
...
class DeviceNotificationListenerService : NotificationListenerService() {
  ...
  companion object {
    ...
    private fun recentPackagesPrefs(context: Context) = context.applicationContext.getSharedPreferences("bot.secure", Context.MODE_PRIVATE)
