...
const val actionAskBot = "ai.bot.app.action.ASK_BOT"

/** Debug action that opens the Voice tab directly for Android E2E automation. */
const val actionOpenVoiceE2e = "ai.bot.app.debug.OPEN_VOICE_E2E"
...
private fun sharedAttachments(
  ...
  // prevents an external intent from turning Bot into a reader for its own private files.
  val validUris =
    (streamUris + clipUris)
