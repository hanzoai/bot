...
/**
 * Universal Bot talk animation: Compose port of the shared Siri-style
 * waveform in `apps/shared/BotKit/Sources/BotChatUI/TalkWaveformView.swift`.
...
internal fun TalkWaveform(
  ...
  // "remove animations" setting explicitly (same pattern as BotMascot).
