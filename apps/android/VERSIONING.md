...
```text
refs/bot/mobile-releases/android/<versionName>-<versionCode>
```

Example:

```text
refs/bot/mobile-releases/android/2026.6.10-2026061008
```
...
If `MATCH_PASSWORD` is not set, the existing manual Gradle-property signing path still works: provide `BOT_ANDROID_STORE_FILE`, `BOT_ANDROID_STORE_PASSWORD`, `BOT_ANDROID_KEY_ALIAS`, and `BOT_ANDROID_KEY_PASSWORD` through your local Gradle user properties before running release tasks.
