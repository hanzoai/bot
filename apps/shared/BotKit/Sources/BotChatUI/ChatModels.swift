...
public typealias BotPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias BotPlatformImage = UIImage
#endif

public enum BotChatCommandFilter: String, CaseIterable, Sendable {
    case all = "All"
    case commands = "Commands"
    case skills = "Skills"
}

public struct BotChatCommandChoice: Identifiable, Hashable, Sendable {
...
public struct BotChatUsageCost: Codable, Hashable, Sendable {
...
public struct BotChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: BotChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(BotChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct BotChatMessageContent: Codable, Hashable, Sendable {
    ...
    public let preview: BotChatCanvasPreview?
    ...
    public init(
        ...
        content: AnyCodable?,
        preview: BotChatCanvasPreview? = nil,
        id: String? = nil,
        name: String? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.preview = try container.decodeIfPresent(BotChatCanvasPreview.self, forKey: .preview)
...
public struct BotChatCanvasPreview: Codable, Hashable, Sendable {
    ...
    public var inlineWidgetPath: String? {
        guard self.kind == "canvas",
              ...
              BotChatWidgetURLResolver.supportsTarget(url)
        else { return nil }
        return url
    }
...
public struct BotChatMessage: Codable, Hashable, Identifiable, Sendable {
    private struct BotMetadata: Codable {
        let id: String?
    ...
    public let content: [BotChatMessageContent]
    public let timestamp: Double?
    public let idempotencyKey: String?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: BotChatUsage?
    ...
    public init(from decoder: Decoder) throws {
        ...
        let decodedBot = try container.decodeIfPresent(BotMetadata.self, forKey: .bot)
        let decodedIdempotencyKey = try decodedBot?.idempotencyKey ??
        ...
        let decodedUsage = try container.decodeIfPresent(BotChatUsage.self, forKey: .usage)
        ...
        self.transcriptMessageID = decodedBot?.id
        ...
        let decodedContent: [BotChatMessageContent] = if let decoded = try? container.decode(
            [BotChatMessageContent].self,
            forKey: .content)
        {
            decoded
        ...
        let audioAttachments: [BotChatMessageContent] = alreadyContainsAudio ? [] : mediaPaths
            .enumerated()
        ...
        self.isTruncated = decodedBot?.truncated == true || decodedContent.contains { content in
...
public struct BotChatInFlightRun: Codable, Sendable {
    public let runId: String
    public let text: String
    public let plan: BotChatPlanSnapshot?

    // periphery:ignore - package tests construct history fixtures; app consumers decode this payload.
    public init(runId: String, text: String, plan: BotChatPlanSnapshot? = nil) {
        self.runId = runId
        self.text = text
        self.plan = plan
    }
...
public struct BotChatPlanSnapshot: Codable, Sendable {
    public let steps: [BotChatPlanStep]
    public let explanation: String?

    // periphery:ignore - package tests construct history fixtures; app consumers decode this payload.
    public init(steps: [BotChatPlanStep], explanation: String? = nil) {
        self.steps = steps
        self.explanation = explanation
    }
}

public struct BotChatSessionInfo: Codable, Sendable {
...
public struct BotChatHistoryPayload: Codable, Sendable {
    public let sessionKey: String
    public let sessionId: String?
    public let messages: [AnyCodable]?
    public let thinkingLevel: String?
    public let sessionInfo: BotChatSessionInfo?
    public let inFlightRun: BotChatInFlightRun?
    ...
    public init(
        ...
        sessionInfo: BotChatSessionInfo? = nil,
        inFlightRun: BotChatInFlightRun? = nil)
    {
...
public struct BotSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct BotSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [BotSessionPreviewItem]
}

public struct BotSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [BotSessionPreviewEntry]

    public init(ts: Int, previews: [BotSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct BotChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct BotChatCreateSessionResponse: Codable, Sendable {
    public let ok: Bool?
    public let key: String
    public let sessionId: String?
}

public struct BotChatEditorAttachment: Codable, Sendable {
    public let mimeType: String
    public let data: String
}

public struct BotChatRewindResponse: Codable, Sendable {
    public let editorText: String?
    public let editorAttachments: [BotChatEditorAttachment]?
}

public struct BotChatForkAtMessageResponse: Codable, Sendable {
    public let sessionKey: String
    public let editorText: String?
    public let editorAttachments: [BotChatEditorAttachment]?
}

public struct BotChatSessionBranch: Codable, Sendable, Equatable, Identifiable {
...
public struct BotChatSessionBranchesResponse: Codable, Sendable {
    public let branches: [BotChatSessionBranch]

    // periphery:ignore - package tests construct branch fixtures; app consumers decode them.
    public init(branches: [BotChatSessionBranch]) {
        self.branches = branches
    }
}

public struct BotChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct BotSessionMessageEventPayload: Codable, Sendable {
    public let sessionKey: String?
    public let agentId: String?
    public let message: BotChatMessage?
...
public struct BotAgentEventPayload: Codable, Sendable, Identifiable {
    public var id: String {
...
public struct BotChatPlanStep: Codable, Hashable, Sendable {
...
public struct BotChatPendingToolCall: Identifiable, Hashable, Sendable {
    public var id: String {
        self.toolCallId
    }
...
public struct BotGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct BotPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: BotPlatformImage?
    public let durationSeconds: Double?
...
public struct BotChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
