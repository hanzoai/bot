...
public struct BotChatReplyTarget: Equatable, Sendable {
...
enum ChatReplyQuote {
    ...
    static func prepend(message: String, replyTarget: BotChatReplyTarget) -> String {
...
extension BotChatViewModel {
    ...
    func setReplyTarget(messageID: UUID, text: String, senderLabel: String) {
        ...
        self.replyTarget = BotChatReplyTarget(
            messageID: messageID,
            text: text,
    ...
    func consumeReplyTarget(_ target: BotChatReplyTarget?) {
