...
enum BotPlatformImageFactory {
    static func image(_ image: BotPlatformImage) -> Image {
        #if os(macOS)
        Image(nsImage: image)
        #else
        Image(uiImage: image)
