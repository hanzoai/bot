...
public struct BotChatSessionAgentStatus: Codable, Sendable, Hashable {
    public let note: String
    public let expiresAt: Double
    public let attention: String?
}

public struct BotChatSessionObserverDigest: Codable, Sendable, Hashable {
...
public struct BotChatThinkingLevelOption: Codable, Identifiable, Sendable, Hashable {
...
public enum BotChatFastMode: Sendable, Equatable, Hashable, Codable {
    case off
    case on
    case automatic
...
public struct BotChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct BotChatSessionSettingsPatch: Sendable, Equatable {
    /// Outer optional means unchanged; inner optional clears the override.
    public let model: String??
    public let thinkingLevel: String??
    public let fastMode: BotChatFastMode??
...
public struct BotChatModelPatchResult: Decodable, Sendable, Equatable {
    public let key: String?
    public let modelProvider: String?
    public let model: String?
    public let thinkingLevel: String?
    public let thinkingLevels: [BotChatThinkingLevelOption]?
    public let fastMode: BotChatFastMode?
    public let effectiveFastMode: BotChatFastMode?
    public let verboseLevel: String?
    ...
    public init(from decoder: Decoder) throws {
        ...
        let entryFastMode = try entry.decodeIfPresent(BotChatFastMode.self, forKey: .fastMode)
        let entryEffectiveFastMode = try entry.decodeIfPresent(
            BotChatFastMode.self,
        ...
        if container.contains(.resolved) {
            ...
            self.thinkingLevels = try resolved.decodeIfPresent(
                [BotChatThinkingLevelOption].self,
                forKey: .thinkingLevels)
            self.fastMode = try resolved.decodeIfPresent(BotChatFastMode.self, forKey: .fastMode)
                ?? entryFastMode
...
public struct BotChatSessionsDefaults: Codable, Sendable {
    public let modelProvider: String?
    public let model: String?
...
public struct BotChatSessionWorktree: Codable, Sendable, Hashable {
    public let id: String?
...
public struct BotChatAgentRuntime: Codable, Sendable, Hashable {
    public let id: String
    public let fallback: String?
    public let source: String?
}

public struct BotChatSessionGroup: Codable, Identifiable, Sendable, Hashable {
    public var id: String {
        self.name
    }
...
public struct BotChatSessionGroupsResponse: Codable, Sendable, Equatable {
    public let groups: [BotChatSessionGroup]
}

public struct BotChatSessionGroupsMutationResponse: Codable, Sendable, Equatable {
    public let ok: Bool
    public let groups: [BotChatSessionGroup]
    public let updatedSessions: Int?
}

public struct BotChatAgentChoice: Codable, Identifiable, Sendable, Hashable {
    public let id: String
    public let name: String?
...
public struct BotChatAgentsListResponse: Codable, Sendable, Equatable {
    public let defaultId: String
    public let agents: [BotChatAgentChoice]

    public init(defaultId: String, agents: [BotChatAgentChoice]) {
        self.defaultId = defaultId
        self.agents = agents
    }
}

public struct BotChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
    public var id: String {
        self.key
    }
    ...
    public var agentStatus: BotChatSessionAgentStatus?
    public var observerDigest: BotChatSessionObserverDigest?
    ...
    public var worktree: BotChatSessionWorktree?
    public var startedAt: Double?
    public var endedAt: Double?
    public var runtimeMs: Double?
    public var agentRuntime: BotChatAgentRuntime?

    public var systemSent: Bool?
    public var abortedLastRun: Bool?
    public var thinkingLevel: String?
    public var verboseLevel: String?
    public var fastMode: BotChatFastMode?
    public var effectiveFastMode: BotChatFastMode?
    ...
    public var thinkingLevels: [BotChatThinkingLevelOption]?
    ...
    public init(
        ...
        swarmLog: String? = nil,
        worktree: BotChatSessionWorktree? = nil,
        fastMode: BotChatFastMode? = nil,
        effectiveFastMode: BotChatFastMode? = nil,
        startedAt: Double? = nil,
        endedAt: Double? = nil,
        runtimeMs: Double? = nil,
        agentRuntime: BotChatAgentRuntime? = nil,
...
public enum BotChatSessionListOrganizer {
    public static func organize(_ sessions: [BotChatSessionEntry]) -> [BotChatSessionEntry] {
    ...
    public static func filter(
        _ sessions: [BotChatSessionEntry],
        search: String) -> [BotChatSessionEntry]
    {
...
public enum BotChatChildSessionPager {
    private static let maxCollectedSessions = 100_000
    private static let maxPageRequests = 100

    public static func collect(
        fetchPage: (Int) async throws -> BotChatSessionsListResponse) async throws
        -> [BotChatSessionEntry]
    {
        var rowsByKey: [String: BotChatSessionEntry] = [:]
...
public struct BotChatSessionsListResponse: Codable, Sendable {
    ...
    public let defaults: BotChatSessionsDefaults?
    public let sessions: [BotChatSessionEntry]
