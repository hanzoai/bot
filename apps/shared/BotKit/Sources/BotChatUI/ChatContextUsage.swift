...
public struct BotChatContextUsage: Equatable, Sendable {
...
enum ChatContextUsageCalculator {
    ...
    static func usage(
        ...
        sessionEntry: BotChatSessionEntry?,
        defaults: BotChatSessionsDefaults?,
        modelContextWindow: Int?) -> BotChatContextUsage?
    {
    ...
    private static func latestRunTokens(in messages: [BotChatMessage]) -> Int? {
    ...
    private static func totalCost(in messages: [BotChatMessage]) -> Double? {
...
extension BotChatViewModel {
    public var contextUsage: BotChatContextUsage? {
    ...
    private func selectedModelContextWindow(sessionEntry: BotChatSessionEntry?) -> Int? {
