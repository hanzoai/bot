...
/// panel keeps using `BotChatView` directly; this shell is the full
/// window experience.
@MainActor
public struct BotChatWindowShell: View {
    public nonisolated static let assistantTraceDefaultsKey = "bot.webchat.showAssistantTrace"
    public nonisolated static let assistantReasoningDefaultsKey = "bot.webchat.showAssistantReasoning"
    public nonisolated static let assistantToolActivityDefaultsKey = "bot.webchat.showAssistantToolActivity"
    ...
    private let emptyAssistantPrompts: [BotChatView.StarterPrompt]
    ...
    public init(
        ...
        emptyAssistantPrompts: [BotChatView.StarterPrompt] = [],
    ...
    private var activeSessionEntry: BotChatSessionEntry? {
...
private struct ChatContextUsageMenu: View {
    let usage: BotChatContextUsage
    let onCompact: () -> Void

    var body: some View {
        Menu {
            Text(self.tokensLine)
                .font(BotChatTypography.body(size: 13, weight: .regular, relativeTo: .body))
