...
public enum ChatTranscriptExporter {
    ...
    public static func markdown(
        sessionTitle: String?,
        sessionKey: String,
        messages: [BotChatMessage]) -> String
    {
    ...
    private static func shouldExport(_ message: BotChatMessage) -> Bool {
    ...
    private static func body(for message: BotChatMessage) -> String {
        var parts: [String] = []
        let text = self.visibleText(in: message)
        if !text.isEmpty {
            parts.append(text)
    ...
    private static func visibleText(in message: BotChatMessage) -> String {
        ChatMessageVisibleText.visibleText(in: message)
    }

    private static func attachments(in message: BotChatMessage) -> [BotChatMessageContent] {
