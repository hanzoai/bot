...
public struct BotChatGatewayRequest: Sendable, Equatable {
...
public enum BotChatSessionTargetPolicy: Sendable {
    case preserveBareKeys
    case scopeBareKeysToSelectedAgent
}

public struct BotChatSessionTarget: Sendable, Equatable {
    ...
    public static func resolve(
        ...
        policy: BotChatSessionTargetPolicy) -> Self
    {
...
public enum BotChatGatewayRequests {
    ...
    public static func agentsList(timeoutMs: Double = 15000) -> BotChatGatewayRequest {
        BotChatGatewayRequest(method: "agents.list", timeoutMs: timeoutMs)
    }

    public static func modelsList() -> BotChatGatewayRequest {
        ...
        fallbackAgentID: String?) -> BotChatGatewayRequest
    {
        ...
        self.add(
            BotChatSessionKey.agentID(from: sessionKey) ?? fallbackAgentID,
            to: &params,
            key: "agentId")
    ...
    public static func questionList() -> BotChatGatewayRequest {
        BotChatGatewayRequest(method: "question.list", timeoutMs: self.defaultTimeoutMs)
    }

    public static func questionGet(id: String) -> BotChatGatewayRequest {
        BotChatGatewayRequest(
            method: "question.get",
    ...
    public static func resolveQuestion(
        id: String,
        answers: [String: [String]]) -> BotChatGatewayRequest
    {
    ...
    public static func cancelQuestion(id: String) -> BotChatGatewayRequest {
        BotChatGatewayRequest(
            method: "question.resolve",
            params: [
                "id": AnyCodable(id),
    ...
    public static func sessionsList(
        ...
        timeoutMs: Double = 15000) -> BotChatGatewayRequest
    {
        var params: [String: AnyCodable] = [
    ...
    public static func sessionGroupsList() -> BotChatGatewayRequest {
        BotChatGatewayRequest(
            method: "sessions.groups.list",
            timeoutMs: self.defaultTimeoutMs)
    }

    public static func sessionGroupsPut(names: [String]) -> BotChatGatewayRequest {
        BotChatGatewayRequest(
    ...
    public static func sessionGroupsRename(
        name: String,
        to: String) -> BotChatGatewayRequest
    {
        BotChatGatewayRequest(
    ...
    public static func sessionGroupsDelete(name: String) -> BotChatGatewayRequest {
        BotChatGatewayRequest(
    ...
    public static func createSession(
        ...
        worktree: Bool?,
        worktreeBaseRef: String? = nil) -> BotChatGatewayRequest
    {
    ...
    public static func abortRun(
        ...
        agentID: String?,
        runID: String,
        requestTimeoutMs: Int = 10000) -> BotChatGatewayRequest
    {
        var params: [String: AnyCodable] = [
    ...
    public static func patchSessionPreferences(
        ...
        verboseLevel: String?? = nil) -> BotChatGatewayRequest
    {
    ...
    private static func fastModeValue(_ mode: BotChatFastMode) -> AnyCodable {
        switch mode {
    ...
    public static func patchSession(
        ...
        pinned: Bool?,
        archived: Bool?,
        unread: Bool?) -> BotChatGatewayRequest
    {
        var params = self.sessionParams(sessionKey: sessionKey, agentID: agentID)
        if let label {
    ...
    public static func deleteSession(
        sessionKey: String,
        agentID: String?) -> BotChatGatewayRequest
    {
        var params = self.sessionParams(sessionKey: sessionKey, agentID: agentID)
    ...
    public static func switchSessionBranch(
        sessionKey: String,
        agentID: String?,
        leafEntryId: String) -> BotChatGatewayRequest
    {
        var params = self.sessionParams(
            sessionKey: sessionKey,
            agentID: agentID,
    ...
    public static func subscribeSessions(timeoutMs: Double = 10000) -> BotChatGatewayRequest {
        BotChatGatewayRequest(
    ...
    public static func setSessionObserverVisibility(
        _ visible: Bool,
        timeoutMs: Double = 10000) -> BotChatGatewayRequest
    {
        BotChatGatewayRequest(
    ...
    public static func compactSession(
        sessionKey: String,
        agentID: String?,
        maxLines: Int? = nil) -> BotChatGatewayRequest
    {
        var params = self.sessionParams(sessionKey: sessionKey, agentID: agentID)
        if let maxLines {
    ...
    public static func history(
        ...
        limit: Int? = nil,
        maxChars: Int? = nil,
        timeoutMs: Int? = nil) -> BotChatGatewayRequest
    {
        ...
        fallbackAgentID: String?) -> BotChatGatewayRequest
    {
        ...
        self.add(
            sessionKey.flatMap(BotChatSessionKey.agentID) ?? fallbackAgentID,
            to: &params,
            key: "agentId")
        return BotChatGatewayRequest(
    ...
    public static func sendMessage(
        ...
        requestTimeoutMs: Int = 30000) -> BotChatGatewayRequest
    {
        var params: [String: AnyCodable] = [
            "sessionKey": AnyCodable(sessionKey),
    ...
    public static func agentWait(
        runID: String,
        timeoutMs: Int,
        requestGraceMs: Int = 5000) -> BotChatGatewayRequest
    {
        BotChatGatewayRequest(
            method: "agent.wait",
            params: [
    ...
    public static func health(timeoutMs: Int) -> BotChatGatewayRequest {
        BotChatGatewayRequest(
            method: "health",
