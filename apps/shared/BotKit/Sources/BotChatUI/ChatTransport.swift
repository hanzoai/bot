...
public enum BotChatTransportEvent: Sendable {
    case health(ok: Bool)
    case tick
    case sessionsChanged(BotChatSessionsChangedEvent)
    case sessionObserver(SessionObserverDigest)
    case chat(BotChatEventPayload)
    case sessionMessage(BotSessionMessageEventPayload)
    case agent(BotAgentEventPayload)
    case questionRequested(QuestionRecord)
    case questionResolved(BotQuestionResolvedEvent)
    case routeChanged
    case seqGap
}

public struct BotQuestionResolvedEvent: Codable, Sendable {
...
public struct BotChatSessionsChangedEvent: Codable, Sendable, Equatable {
    ...
    public let agentStatus: BotChatSessionAgentStatus?
    public let observerDigest: BotChatSessionObserverDigest?
    ...
    public init(
        ...
        agentStatus: BotChatSessionAgentStatus? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.agentStatus = try decode(BotChatSessionAgentStatus.self, forKey: .agentStatus)
        self.observerDigest = try decode(BotChatSessionObserverDigest.self, forKey: .observerDigest)
...
public struct BotChatTransportRouteLease: Sendable {
    public typealias SendMessage = @Sendable (
        _ sessionKey: String,
        _ message: String,
        _ thinking: String,
        _ idempotencyKey: String,
        _ attachments: [BotChatAttachmentPayload]) async throws -> BotChatSendResponse
    public typealias RequestHistory = @Sendable (String) async throws -> BotChatHistoryPayload
    ...
    public typealias RequestTargetedHistory = @Sendable (
        _ sessionKey: String,
        _ agentID: String?) async throws -> BotChatHistoryPayload
    ...
    public func requestHistory(
        sessionKey: String,
        agentID: String? = nil) async throws -> BotChatHistoryPayload
    {
        try await self.requestTargetedHistoryImpl(sessionKey, agentID)
    }
}

public enum BotChatTransportRouteLeaseResult: Sendable {
    case available(BotChatTransportRouteLease)
...
public struct BotChatSessionSettingsRouteLease: Sendable {
    public typealias PatchSessionSettings = @Sendable (
        _ sessionKey: String,
        _ agentID: String?,
        _ patch: BotChatSessionSettingsPatch) async throws -> BotChatModelPatchResult?
...
public struct BotChatSessionMutationRouteLease: Sendable {
...
public struct BotChatSessionGroupsRouteLease: Sendable {
    public typealias ListGroups = @Sendable () async throws -> BotChatSessionGroupsResponse?
    public typealias PutGroups = @Sendable ([String]) async throws -> BotChatSessionGroupsMutationResponse
    public typealias RenameGroup = @Sendable (String, String) async throws -> BotChatSessionGroupsMutationResponse
    public typealias DeleteGroup = @Sendable (String) async throws -> BotChatSessionGroupsMutationResponse
    ...
    public func listGroups() async throws -> BotChatSessionGroupsResponse? {
        try await self.listGroupsImpl()
    }

    public func putGroups(names: [String]) async throws -> BotChatSessionGroupsMutationResponse {
        try await self.putGroupsImpl(names)
    }

    public func renameGroup(name: String, to: String) async throws -> BotChatSessionGroupsMutationResponse {
        try await self.renameGroupImpl(name, to)
    }

    public func deleteGroup(name: String) async throws -> BotChatSessionGroupsMutationResponse {
...
public struct BotChatNewSessionRouteLease: Sendable {
    public typealias ListAgents = @Sendable () async throws -> BotChatAgentsListResponse?
    public typealias CreateSession = @Sendable (
        ...
        _ worktree: Bool?,
        _ worktreeBaseRef: String?) async throws -> BotChatCreateSessionResponse
    ...
    public func listAgents() async throws -> BotChatAgentsListResponse? {
...
public enum BotChatTransportSendError: Error, Sendable {
    case notDispatched
}

public enum BotChatTransportUpgradeMessage {
...
public enum BotChatRunTerminalState: Sendable, Equatable {
    case completed
    case failed(message: String)
}

public enum BotChatRunObservation: Sendable, Equatable {
    case terminal(BotChatRunTerminalState)
    case checkAgain
    case unavailable
...
public struct BotChatMetadataCapabilities: Codable, Sendable, Equatable {
...
public struct BotChatSwarmRouteLease: Sendable {
    ...
    public typealias ListChildSessions = @Sendable (_ parentKey: String) async throws -> [BotChatSessionEntry]
    ...
    public func listChildSessions(parentKey: String) async throws -> [BotChatSessionEntry] {
...
public protocol BotChatTransport: Sendable {
    ...
    func renameSessionGroup(name: String, to: String) async throws -> BotChatSessionGroupsMutationResponse
    ...
    func rewindSession(sessionKey: String, entryId: String) async throws -> BotChatRewindResponse
    ...
    func waitForRunCompletion(runId: String, timeoutMs: Int) async -> BotChatRunObservation
...
extension BotChatTransport {
    ...
    public func acquireSwarmRouteLease() async -> BotChatSwarmRouteLease? {
        let transport = self
    ...
    public func requestFullMessage(sessionKey _: String, messageID _: String) async throws -> BotChatMessage? {
        nil
    }
        ...
        replacing failedResource: BotChatWidgetResource?) async -> BotChatWidgetResource?
    {
        ...
        return BotChatWidgetResource(url: url)
    }
    ...
    public func acquireOutboxRouteLease() async -> BotChatTransportRouteLeaseResult {
        let transport = self
    ...
    public func acquireSessionSettingsRouteLease() async -> BotChatSessionSettingsRouteLease? {
        let transport = self
    ...
    public func acquireSessionMutationRouteLease() async -> BotChatSessionMutationRouteLease? {
        let transport = self
    ...
    public func acquireSessionGroupsRouteLease() async -> BotChatSessionGroupsRouteLease? {
        let transport = self
    ...
    public func acquireNewSessionRouteLease() async -> BotChatNewSessionRouteLease? {
        let transport = self
    ...
    public func waitForRunCompletion(runId _: String, timeoutMs _: Int) async -> BotChatRunObservation {
        .unavailable
    }
    ...
    public func listChildSessions(parentKey _: String) async throws -> [BotChatSessionEntry] {
        []
    }
    ...
    public func listSessions(limit: Int?) async throws -> BotChatSessionsListResponse {
        try await self.listSessions(limit: limit, search: nil, archived: false)
    }

    public func listSessions(limit: Int?, archived: Bool) async throws -> BotChatSessionsListResponse {
    ...
    public func listSessionGroups() async throws -> BotChatSessionGroupsResponse? {
        nil
    }

    public func putSessionGroups(names _: [String]) async throws -> BotChatSessionGroupsMutationResponse {
        throw NSError(
            domain: "BotChatTransport",
            code: 0,
    ...
    public func renameSessionGroup(
        name _: String,
        to _: String) async throws -> BotChatSessionGroupsMutationResponse
    {
        throw NSError(
            domain: "BotChatTransport",
            code: 0,
    ...
    public func deleteSessionGroup(name _: String) async throws -> BotChatSessionGroupsMutationResponse {
        throw NSError(
            domain: "BotChatTransport",
            code: 0,
    ...
    public func rewindSession(
        sessionKey _: String,
        entryId _: String) async throws -> BotChatRewindResponse
    {
        throw NSError(
            domain: "BotChatTransport",
            code: 0,
    ...
    public func forkSessionAtMessage(
        sessionKey _: String,
        entryId _: String) async throws -> BotChatForkAtMessageResponse
    {
        throw NSError(
            domain: "BotChatTransport",
            code: 0,
    ...
    public func listSessionBranches(
        sessionKey _: String,
        agentID _: String?) async throws -> BotChatSessionBranchesResponse
    {
        throw NSError(
            domain: "BotChatTransport",
            code: 0,
    ...
    public func listModels() async throws -> [BotChatModelChoice] {
        throw NSError(
            domain: "BotChatTransport",
            code: 0,
    ...
    public func listCommands(sessionKey _: String) async throws -> [BotChatCommandChoice] {
        []
    }
...
public enum BotChatSessionRoutingContract {
