...
struct ChatMathBlockView: View {
    ...
    @ScaledMetric(relativeTo: .body) private var fontSize: CGFloat = BotChatTypography.bodySize
...
struct ChatMarkdownTableView: View {
    ...
    private func cell(_ text: String, isHeader: Bool) -> some View {
        Text(self.inlineMarkdown(text))
            .font(isHeader ? BotChatTypography.footnoteSemiBold : BotChatTypography.footnote)
            .foregroundStyle(BotChatTheme.assistantText)
            .textSelection(.enabled)
    }
