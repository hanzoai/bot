...
struct ChatSessionInspectorDetails: Equatable {
    ...
    private static func runState(for session: BotChatSessionEntry) -> String? {
...
struct ChatSessionInspectorSheet: View {
    ...
    @State private var displayedSession: BotChatSessionEntry
    @State private var groups: [BotChatSessionGroup] = []
    @State private var isMutatingGroup = false
    @State private var errorText: String?

    init(viewModel: BotChatViewModel, session: BotChatSessionEntry) {
...
struct ChatSessionGroupsSheet: View {
    ...
    @State private var renameTarget: BotChatSessionGroup?
    @State private var renameText = ""
    @State private var deleteTarget: BotChatSessionGroup?
    @State private var routeLease: BotChatSessionGroupsRouteLease?
    ...
    private func renameGroup(_ target: BotChatSessionGroup, to name: String) async {
        defer { self.isMutating = false }
    ...
    private func deleteGroup(_ target: BotChatSessionGroup) async {
        defer { self.isMutating = false }
...
public struct ChatNewSessionOptionsPopover: View {
    ...
    @State private var agents: [BotChatAgentChoice] = []
    @State private var selectedAgentID = ""
    @State private var usesWorktree = false
    @State private var baseRef = ""
    @State private var isLoading = true
    @State private var isCreating = false
    @State private var routeLease: BotChatNewSessionRouteLease?
    @State private var errorText: String?

    public init(viewModel: BotChatViewModel, onComplete: @escaping () -> Void) {
        self.viewModel = viewModel
        self.onComplete = onComplete
    }

    private var selectedAgent: BotChatAgentChoice? {
    ...
    public var body: some View {
        VStack(alignment: .leading, spacing: 14) {
            Text("New Thread Options")
                .font(BotChatTypography.body(size: 15, weight: .semibold, relativeTo: .headline))
