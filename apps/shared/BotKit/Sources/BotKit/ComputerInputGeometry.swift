...
public struct BotComputerDisplayGeometry: Sendable, Equatable {
...
public enum BotComputerInputGeometry {
    ...
    public static func displayFrameId(
        ...
        sourceHeight: Double,
        referenceWidth: Int,
        display: BotComputerDisplayGeometry) -> String
    {
        let descriptor = [
            String(displayID),
    ...
    public static func isValidMappingGeometry(
        sourceWidth: Double,
        sourceHeight: Double,
        display: BotComputerDisplayGeometry) -> Bool
    {
    ...
    public static func mapReferencePointToGlobal(
        ...
        display: BotComputerDisplayGeometry) -> (x: Double, y: Double)
    {
