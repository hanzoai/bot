...
public struct SkillStatusConfigCheck: Codable, Identifiable, Sendable {
    ...
    public let value: BotProtocol.AnyCodable?
    ...
    public init(path: String, value: BotProtocol.AnyCodable?, satisfied: Bool) {
        self.path = path
        self.value = value
...
public struct SkillUpdateResult: Codable, Sendable {
    public let ok: Bool
    public let skillKey: String
    public let config: [String: BotProtocol.AnyCodable]?
}
