...
public enum BotComputerCommand: String, Codable, Sendable {
...
public enum BotComputerAction: String, Codable, Sendable {
...
public enum BotComputerScrollDirection: String, Codable, Sendable {
    case up
    case down
    case left
    case right
...
public struct BotComputerActParams: Codable, Sendable, Equatable {
    public var action: BotComputerAction
    ...
    public var scrollDirection: BotComputerScrollDirection?
    ...
    public init(
        ...
        scrollDirection: BotComputerScrollDirection? = nil,
...
public struct BotComputerActResult: Codable, Sendable, Equatable {
    public var ok: Bool
