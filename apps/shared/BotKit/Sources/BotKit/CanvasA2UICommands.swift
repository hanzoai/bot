...
public enum BotCanvasA2UICommand: String, Codable, Sendable {
...
public struct BotCanvasA2UIPushParams: Codable, Sendable, Equatable {
    public var messages: [AnyCodable]
}

public struct BotCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
