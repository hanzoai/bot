...
public enum BotWatchPayloadType: String, Codable, Sendable, Equatable {
    case notify = "watch.notify"
...
public enum BotWatchExecApprovalDecision: String, Codable, Sendable, Equatable {
    case allowOnce = "allow-once"
    case deny
}

public enum BotWatchExecApprovalCloseReason: String, Codable, Sendable, Equatable {
    case expired
...
public struct BotWatchAction: Codable, Sendable, Equatable, Identifiable {
...
public struct BotWatchExecApprovalItem: Codable, Sendable, Equatable, Identifiable {
    public var id: String
    ...
    public var allowedDecisions: [BotWatchExecApprovalDecision]
    ...
    public init(
        ...
        allowedDecisions: [BotWatchExecApprovalDecision] = [],
...
public struct BotWatchExecApprovalPromptMessage: Codable, Sendable, Equatable {
    public var type: BotWatchPayloadType
    public var approval: BotWatchExecApprovalItem
    public var sentAtMs: Int64?
    public var resetResolutionAttemptId: String?

    public init(
        approval: BotWatchExecApprovalItem,
        sentAtMs: Int64? = nil,
...
public struct BotWatchExecApprovalResolveMessage: Codable, Sendable, Equatable {
    public var type: BotWatchPayloadType
    public var approvalId: String
    public var gatewayStableID: String?
    public var decision: BotWatchExecApprovalDecision
...
public enum BotWatchExecApprovalOutcome: String, Codable, Sendable, Equatable {
    case allowedOnce
    case allowedAlways
    case denied
}

public struct BotWatchExecApprovalResolvedMessage: Codable, Sendable, Equatable {
    public var type: BotWatchPayloadType
    public var approvalId: String
    public var gatewayStableID: String?
    public var decision: BotWatchExecApprovalDecision?
    public var outcome: BotWatchExecApprovalOutcome?
    ...
    public init(
        approvalId: String,
        gatewayStableID: String? = nil,
        decision: BotWatchExecApprovalDecision? = nil,
        outcome: BotWatchExecApprovalOutcome? = nil,
...
public struct BotWatchExecApprovalExpiredMessage: Codable, Sendable, Equatable {
    public var type: BotWatchPayloadType
    public var approvalId: String
    public var gatewayStableID: String?
    public var reason: BotWatchExecApprovalCloseReason
...
public struct BotWatchExecApprovalSnapshotMessage: Codable, Sendable, Equatable {
    public var type: BotWatchPayloadType
    public var approvals: [BotWatchExecApprovalItem]
    public var gatewayStableID: String?
    public var sentAtMs: Int64?
    ...
    public init(
        approvals: [BotWatchExecApprovalItem],
        gatewayStableID: String? = nil,
        sentAtMs: Int64? = nil,
...
public struct BotWatchExecApprovalSnapshotRequestItem: Codable, Sendable, Equatable {
    public var approvalId: String
...
public struct BotWatchExecApprovalSnapshotRequestMessage: Codable, Sendable, Equatable {
    public var type: BotWatchPayloadType
    public var requestId: String
    public var sentAtMs: Int64?
    public var gatewayStableID: String?
    public var heldApprovals: [BotWatchExecApprovalSnapshotRequestItem]

    public init(
        requestId: String,
        sentAtMs: Int64? = nil,
        gatewayStableID: String? = nil,
        heldApprovals: [BotWatchExecApprovalSnapshotRequestItem] = [])
    {
...
public struct BotWatchChatItem: Codable, Sendable, Equatable, Identifiable {
    public var id: String
...
public struct BotWatchChatCompletionMessage: Codable, Sendable, Equatable {
    public var type: BotWatchPayloadType
...
public enum BotWatchAppStatusCode: String, Codable, Sendable, Equatable {
...
public struct BotWatchAppStatus: Codable, Sendable, Equatable {
    public var code: BotWatchAppStatusCode
    public var localizationKey: String?
    public var arguments: [String]
    public var verbatim: String?

    public init(
        code: BotWatchAppStatusCode,
...
public struct BotWatchAppSnapshotMessage: Codable, Sendable, Equatable {
    public var type: BotWatchPayloadType
    public var gatewayStatus: BotWatchAppStatus
    ...
    public var gatewayStableID: String?
    public var talkStatus: BotWatchAppStatus
    ...
    public var chatItems: [BotWatchChatItem]?
    public var chatStatus: BotWatchAppStatus?
    public var chatStatusText: String?
    public var sentAtMs: Int64?
    public var snapshotId: String?

    public init(
        gatewayStatus: BotWatchAppStatus,
        ...
        sessionKey: String,
        gatewayStableID: String? = nil,
        talkStatus: BotWatchAppStatus,
        talkStatusText: String,
        talkEnabled: Bool,
        talkListening: Bool,
        talkSpeaking: Bool,
        pendingApprovalCount: Int,
        chatItems: [BotWatchChatItem]? = nil,
        chatStatus: BotWatchAppStatus? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(BotWatchPayloadType.self, forKey: .type)
        ...
        self.chatItems = try container.decodeIfPresent([BotWatchChatItem].self, forKey: .chatItems)
        ...
        {
            self.gatewayStatus = BotWatchAppStatus(
                code: .legacy,
        ...
        {
            self.talkStatus = BotWatchAppStatus(
                code: .legacy,
    ...
    private static func decodeLegacyGatewayStatus(
        text: String?,
        connected: Bool) -> BotWatchAppStatus
    {
        if connected {
        ...
        return BotWatchAppStatus(code: .legacy, verbatim: text)
    }
    ...
    private static func decodeLegacyTalkStatus(
        ...
        enabled: Bool,
        listening: Bool,
        speaking: Bool) -> BotWatchAppStatus
    {
        if speaking {
        ...
        guard let text, !text.isEmpty else {
            return BotWatchAppStatus(code: .talkReady)
        }
        return BotWatchAppStatus(code: .legacy, verbatim: text)
    }
    ...
    private static func decodeLegacyChatStatus(
        code: String?,
        text: String?) -> BotWatchAppStatus?
    {
        let statusCode: BotWatchAppStatusCode? = switch code {
        case "connectIPhone":
            BotWatchAppStatusCode.chatConnectIPhone
        case "noMessages":
            BotWatchAppStatusCode.chatNoMessages
        case "unavailable":
            BotWatchAppStatusCode.chatUnavailable
        default:
            nil
        }
        if let statusCode {
            return BotWatchAppStatus(code: statusCode)
        }
        guard let text, !text.isEmpty else { return nil }
        return BotWatchAppStatus(code: .legacy, verbatim: text)
    }

    private static func legacyText(for status: BotWatchAppStatus) -> String {
    ...
    private static func legacyGatewayText(for code: BotWatchAppStatusCode) -> String {
        switch code {
    ...
    private static func legacyTalkText(for code: BotWatchAppStatusCode) -> String {
        switch code {
        case .talkOff: "Off"
    ...
    private static func legacyChatText(for code: BotWatchAppStatusCode) -> String {
        switch code {
...
public struct BotWatchAppSnapshotRequestMessage: Codable, Sendable, Equatable {
    public var type: BotWatchPayloadType
    public var requestId: String
    public var sentAtMs: Int64?
...
public enum BotWatchAppCommand: String, Codable, Sendable, Equatable {
    case refresh
...
public struct BotWatchAppCommandMessage: Codable, Sendable, Equatable {
    public var type: BotWatchPayloadType
    public var command: BotWatchAppCommand
    public var commandId: String
    public var sessionKey: String?
    public var gatewayStableID: String?
    public var text: String?
