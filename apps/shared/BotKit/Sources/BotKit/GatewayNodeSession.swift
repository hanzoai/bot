...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.hanzo.bot", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.hanzo.bot", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: HanzoBotProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
