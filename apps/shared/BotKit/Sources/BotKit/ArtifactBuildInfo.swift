...
public struct ArtifactBuildInfo: Equatable, Sendable {
        ...
        versionKeys: [String] = ["CFBundleShortVersionString"])
    {
        ...
        self.gitCommit = Self.validGitCommit(Self.nonEmptyString(infoDictionary["BotGitCommit"]))
        let buildTimestamp = Self.nonEmptyString(infoDictionary["BotBuildTimestamp"])
