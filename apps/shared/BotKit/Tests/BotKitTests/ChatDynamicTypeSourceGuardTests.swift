...
struct ChatDynamicTypeSourceGuardTests {
        ...
        composer: String)
    {
        ...
        return try (
            messageViews: String(
                contentsOf: root.appendingPathComponent("Sources/BotChatUI/ChatMessageViews.swift"),
                encoding: .utf8),
            chatView: String(
                contentsOf: root.appendingPathComponent("Sources/BotChatUI/ChatView.swift"),
                encoding: .utf8),
            composer: String(
                contentsOf: root.appendingPathComponent("Sources/BotChatUI/ChatComposer.swift"),
                encoding: .utf8))
    }
}
