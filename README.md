# Bot — Autonomous Workforce Platform
...
<p align="center">
    <picture>
        ...
        <img src="https://raw.githubusercontent.com/hanzoai/bot/main/docs/assets/bot-logo-text.png" alt="Bot" width="500">
    </picture>
</p>
...
<p align="center">
  ...
  <a href="https://discord.gg/botd"><img src="https://img.shields.io/discord/1456350064065904867?label=Discord&logo=discord&logoColor=white&color=5865F2&style=for-the-badge" alt="Discord"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

**Bot** is a _personal AI assistant_ you run on your own devices.
...
# Send a message
bot message send --to +1234567890 --message "Hello from Bot"

# Talk to the assistant (optionally deliver back to any connected channel: WhatsApp/Telegram/Slack/Discord/Google Chat/Signal/iMessage/BlueBubbles/Microsoft Teams/Matrix/Zalo/Zalo Personal/WebChat)
bot agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.hanzo.bot/install/updating) (and run `bot doctor`).
...
Switch channels (git + npm): `bot update --channel stable|beta|dev`.
...
pnpm bot onboard --install-daemon

# Dev loop (auto-reload on TS changes)
pnpm gateway:watch
```

Note: `pnpm bot ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `bot` binary.

## Security defaults (DM access)

Bot connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.
...
- Approve with: `bot pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.allowFrom` / `channels.slack.allowFrom`; legacy: `channels.discord.dm.allowFrom`, `channels.slack.dm.allowFrom`).

Run `bot doctor` to surface risky/misconfigured DM policies.
...
[![Star History Chart](https://api.star-history.com/svg?repos=bot/bot&type=date&legend=top-left)](https://www.star-history.com/#bot/bot&type=date&legend=top-left)
...
- [Browser control](https://docs.hanzo.bot/tools/browser): dedicated bot Chrome/Chromium, snapshots, actions, uploads, profiles.
...
Bot can auto-configure Tailscale **Serve** (tailnet-only) or **Funnel** (public) while the Gateway stays bound to loopback. Configure `gateway.tailscale.mode`:
...
- `gateway.bind` must stay `loopback` when Serve/Funnel is enabled (Bot enforces this).
...
## Skills registry (BotHub)

BotHub is a minimal skill registry. With BotHub enabled, the agent can search for skills automatically and pull in new ones as needed.

[BotHub](https://bothub.com)
...
> "OK I want to make a PR with this skill back to bot... make a new one that
...
- Link the device: `pnpm bot channels login` (stores creds in `~/.bot/credentials`).
...
Special thanks to Adam Doppelt for the project.
...
<p align="left">
  ...
  <a href="https://github.com/ryancnelson"><img src="https://avatars.githubusercontent.com/u/347171?v=4&s=48" width="48" height="48" alt="ryancnelson" title="ryancnelson"/></a> <a href="https://github.com/search?q=Samrat%20Jha"><img src="assets/avatar-placeholder.svg" width="48" height="48" alt="Samrat Jha" title="Samrat Jha"/></a> <a href="https://github.com/search?q=seans-bot"><img src="assets/avatar-placeholder.svg" width="48" height="48" alt="seans-bot" title="seans-bot"/></a> <a href="https://github.com/senoldogann"><img src="https://avatars.githubusercontent.com/u/45736551?v=4&s=48" width="48" height="48" alt="senoldogann" title="senoldogann"/></a> <a href="https://github.com/Seredeep"><img src="https://avatars.githubusercontent.com/u/22802816?v=4&s=48" width="48" height="48" alt="Seredeep" title="Seredeep"/></a> <a href="https://github.com/sergical"><img src="https://avatars.githubusercontent.com/u/3760543?v=4&s=48" width="48" height="48" alt="sergical" title="sergical"/></a> <a href="https://github.com/search?q=shatner"><img src="assets/avatar-placeholder.svg" width="48" height="48" alt="shatner" title="shatner"/></a> <a href="https://github.com/shiv19"><img src="https://avatars.githubusercontent.com/u/9407019?v=4&s=48" width="48" height="48" alt="shiv19" title="shiv19"/></a> <a href="https://github.com/shiyuanhai"><img src="https://avatars.githubusercontent.com/u/1187370?v=4&s=48" width="48" height="48" alt="shiyuanhai" title="shiyuanhai"/></a> <a href="https://github.com/Shrinija17"><img src="https://avatars.githubusercontent.com/u/199155426?v=4&s=48" width="48" height="48" alt="Shrinija17" title="Shrinija17"/></a>
