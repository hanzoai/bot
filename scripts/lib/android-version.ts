// Android Version script supports Bot repository automation.
...
export function renderAndroidVersionProperties(
  ...
  return `# Shared Android version defaults.\n# Source of truth: apps/android/version.json\n# Generated by scripts/android-sync-versioning.ts.\n\nBOT_ANDROID_VERSION_NAME=${version.canonicalVersion}\nBOT_ANDROID_VERSION_CODE=${version.versionCode}\n`;
}
