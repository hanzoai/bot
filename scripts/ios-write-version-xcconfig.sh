...
- BOT_IOS_VERSION = exact canonical iOS version
...
RESOLVED_GIT_COMMIT="$(bot_resolve_git_commit "${ROOT_DIR}")"
RESOLVED_BUILD_TIMESTAMP="$(bot_resolve_build_timestamp)"
...
BOT_IOS_VERSION = ${IOS_VERSION}
BOT_MARKETING_VERSION = ${MARKETING_VERSION}
BOT_BUILD_VERSION = ${BUILD_NUMBER}
BOT_GIT_COMMIT = ${RESOLVED_GIT_COMMIT}
BOT_BUILD_TIMESTAMP = ${RESOLVED_BUILD_TIMESTAMP}
EOF
