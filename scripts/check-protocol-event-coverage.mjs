...
// macOS, so the iOS coverage owner lives in BotChatUI.
const IOS_SCAN_ROOTS = ["apps/ios/Sources", "apps/shared/BotKit/Sources"];
const IOS_SENTINEL_FILE =
  "apps/shared/BotKit/Sources/BotChatUI/ChatGatewayPayloadCodec.swift";
const ANDROID_SCAN_ROOT = "apps/android/app/src/main/java/ai/bot/app";
const ANDROID_SENTINEL_FILES = [
  "apps/android/app/src/main/java/ai/bot/app/gateway/GatewaySession.kt",
  "apps/android/app/src/main/java/ai/bot/app/chat/ChatController.kt",
];
