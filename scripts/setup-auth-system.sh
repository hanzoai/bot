...
# Update service file
SERVICE_FILE="$SCRIPT_DIR/systemd/bot-auth-monitor.service"
...
cp "$SCRIPT_DIR/systemd/bot-auth-monitor.service" ~/.config/systemd/user/
cp "$SCRIPT_DIR/systemd/bot-auth-monitor.timer" ~/.config/systemd/user/
