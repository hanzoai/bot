...
const SHARED_LOCATION_PREFIX = "../shared/BotKit/Sources/";
const SHARED_SOURCE_ROOT = "apps/shared/BotKit/Sources";
...
export function validateFindings(value, label) {
  ...
  return value.map((finding, index) => {
    ...
    if (
      ...
      throw new Error(`${label} finding ${index} is outside shared BotKit sources`);
    }
