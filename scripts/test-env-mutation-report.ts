#!/usr/bin/env node
// Test Env Mutation Report script supports Bot repository automation.
...
const DEFAULT_ALLOWED_FILES = new Map([
  ["src/test-utils/bot-test-state.ts", "canonical Bot test state helper"],
  ...
  ["test/setup-bot-runtime.ts", "global runtime-test setup owns process env isolation"],
  [
...
function printHelp(): void {
  process.stdout.write(`Bot test env mutation report
