...
// Summarizes Bot performance source fixtures for reports.
...
function printHelp() {
  console.log(`Usage: node scripts/bot-performance-source-summary.mjs --source-dir <dir> [--baseline-source-dir <dir>] [--output <summary.md>]

Summarizes Bot-native performance probe artifacts for CI reports.`);
}
