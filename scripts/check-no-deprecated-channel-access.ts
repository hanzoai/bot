// Check No Deprecated Channel Access script supports Bot repository automation.
...
const RULES: Rule[] = [
  ...
  },
  {
    ...
    pattern: /from\s+["']bot\/plugin-sdk\/group-access["']/u,
  },
  {
  ...
  },
  {
    ...
    pattern: /from\s+["']bot\/plugin-sdk\/command-auth["']/u,
  },
];
