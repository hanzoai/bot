...
async function main() {
  ...
  const retryOptions = {
    attempts: positiveInteger(
      process.env.BOT_CLAWHUB_VERIFY_ATTEMPTS,
      DEFAULT_ATTEMPTS,
      "BOT_CLAWHUB_VERIFY_ATTEMPTS",
      MAX_ATTEMPTS,
    ),
    delayMs: positiveInteger(
      process.env.BOT_CLAWHUB_VERIFY_DELAY_MS,
      DEFAULT_DELAY_MS,
      "BOT_CLAWHUB_VERIFY_DELAY_MS",
      MAX_DELAY_MS,
    ),
    timeoutMs: positiveInteger(
      process.env.BOT_CLAWHUB_VERIFY_ATTEMPT_TIMEOUT_MS,
      DEFAULT_ATTEMPT_TIMEOUT_MS,
      "BOT_CLAWHUB_VERIFY_ATTEMPT_TIMEOUT_MS",
    ),
  };
  const directMode = [
