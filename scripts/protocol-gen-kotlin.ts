// Protocol Gen Kotlin script supports Bot repository automation.
...
const gatewayOutputPath = path.join(
  repoRoot,
  "apps/android/app/src/main/java/ai/bot/app/gateway/GatewayProtocol.kt",
);
const constantsOutputPath = path.join(
  repoRoot,
  "apps/android/app/src/main/java/ai/bot/app/protocol/BotProtocolConstants.kt",
);
...
const androidEnums: EnumSpec[] = [
  ...
  enumSpec("BotCanvasCommand", "canvas.", [
    ["Present", "present"],
    ["Hide", "hide"],
    ["Navigate", "navigate"],
    ["Eval", "eval"],
  ...
  enumSpec("BotCanvasA2UICommand", "canvas.a2ui.", [
    ["Push", "push"],
    ["PushJSONL", "pushJSONL"],
    ["Reset", "reset"],
  ]),
  enumSpec("BotCameraCommand", "camera.", [
    ["List", "list"],
    ["Snap", "snap"],
    ["Clip", "clip"],
  ]),
  enumSpec("BotSmsCommand", "sms.", [
    ["Send", "send"],
    ["Search", "search"],
  ]),
  enumSpec("BotTalkCommand", "talk.", [
    ["PttStart", "ptt.start"],
    ["PttStop", "ptt.stop"],
    ["PttCancel", "ptt.cancel"],
    ["PttOnce", "ptt.once"],
  ]),
  enumSpec("BotLocationCommand", "location.", [["Get", "get"]]),
  enumSpec("BotDeviceCommand", "device.", [
    ["Status", "status"],
    ["Info", "info"],
  ...
  enumSpec("BotNotificationsCommand", "notifications.", [
    ["List", "list"],
    ["Actions", "actions"],
  ]),
  enumSpec("BotSystemCommand", "system.", [["Notify", "notify"]]),
  enumSpec("BotPhotosCommand", "photos.", [["Latest", "latest"]]),
  enumSpec("BotContactsCommand", "contacts.", [
    ["Search", "search"],
    ["Add", "add"],
  ]),
  enumSpec("BotCalendarCommand", "calendar.", [
    ["Events", "events"],
    ["Add", "add"],
  ]),
  enumSpec("BotMotionCommand", "motion.", [
    ["Activity", "activity"],
    ["Pedometer", "pedometer"],
  ]),
  enumSpec("BotCallLogCommand", "callLog.", [["Search", "search"]]),
  enumSpec("BotMobileUiCommand", "mobile.ui.", [
    ["Observe", "observe"],
    ["Act", "act"],
  ]),
];
