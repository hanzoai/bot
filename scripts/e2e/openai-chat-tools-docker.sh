...
IMAGE_NAME="$(docker_e2e_resolve_image "bot-openai-chat-tools-e2e" BOT_OPENAI_CHAT_TOOLS_E2E_IMAGE)"
SKIP_BUILD="${BOT_OPENAI_CHAT_TOOLS_E2E_SKIP_BUILD:-0}"
PORT="$(docker_e2e_read_tcp_port_env BOT_OPENAI_CHAT_TOOLS_PORT 18789)"
TIMEOUT_SECONDS="$(docker_e2e_read_positive_int_env BOT_OPENAI_CHAT_TOOLS_TIMEOUT_SECONDS 180)"
MAX_BODY_BYTES="$(
  docker_e2e_read_positive_int_env BOT_OPENAI_CHAT_TOOLS_MAX_BODY_BYTES 1048576
)"
TOKEN="openai-chat-tools-e2e-$$"
PROFILE_FILE="${BOT_OPENAI_CHAT_TOOLS_PROFILE_FILE:-${BOT_TESTBOX_PROFILE_FILE:-$HOME/.bot-testbox-live.profile}}"
...
BOT_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 openai-chat-tools empty)"
...
docker_e2e_run_logged_with_harness openai-chat-tools \
  ...
  -e "BOT_OPENAI_CHAT_TOOLS_MODEL=${BOT_OPENAI_CHAT_TOOLS_MODEL:-openai/gpt-5.4-mini}" \
  -e "BOT_OPENAI_CHAT_TOOLS_TIMEOUT_SECONDS=$TIMEOUT_SECONDS" \
  -e "BOT_OPENAI_CHAT_TOOLS_MAX_BODY_BYTES=$MAX_BODY_BYTES" \
