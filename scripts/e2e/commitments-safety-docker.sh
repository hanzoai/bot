...
IMAGE_NAME="$(docker_e2e_resolve_image "bot-commitments-safety-e2e" BOT_COMMITMENTS_SAFETY_E2E_IMAGE)"
CONTAINER_NAME="bot-commitments-safety-e2e-$$"
RUN_LOG="$(mktemp -t bot-commitments-safety-log.XXXXXX)"
