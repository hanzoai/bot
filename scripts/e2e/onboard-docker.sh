...
TRASH
  ...
  run_wizard_cmd() {
    ...
    mkfifo "$input_fifo"
    local log_path="/tmp/bot-onboard-${case_name}.log"
  ...
  send_skills_flow() {
    ...
    config_path="$HOME/.bot/bot.json"
    sessions_dir="$HOME/.bot/agents/main/sessions"
