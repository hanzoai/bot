...
const pluginRecordSnapshot = () => {
  const config = readJson(botPath("bot.json"));
...
function botPath(...parts) {
  return path.join(home, ".bot", ...parts);
}
...
function seedInstallState() {
  writeJson(botPath("extensions", "lossless-claw", "package.json"), {
    name: "@example/lossless-claw",
    version: "0.9.0",
  });
  writeJson(process.env.BOT_CONFIG_PATH, { plugins: {} });
  writePluginInstallIndexForE2E({
    version: 1,
    warning: "DO NOT EDIT. This file is generated by Bot plugin registry commands.",
...
function isCorruptPluginDisabledAfterUpdate(evidence, pluginId) {
  ...
  return (
    ...
    message.includes("Bot will continue without it")
  );
}
