...
MODEL_REF="${BOT_OPENAI_CHAT_TOOLS_MODEL:?missing BOT_OPENAI_CHAT_TOOLS_MODEL}"
GATEWAY_LOG="/tmp/bot-openai-chat-tools-gateway.log"
CLIENT_LOG="/tmp/bot-openai-chat-tools-client.log"
gateway_pid=""
...
PORT="$PORT" BOT_GATEWAY_TOKEN="$TOKEN" MODEL_REF="$MODEL_REF" \
