// Host Command script supports Bot repository automation.
...
const HOST_COMMAND_CHILD_PID_PREFIX = "__BOT_HOST_COMMAND_CHILD_PID__";
const HOST_COMMAND_SPAWN_ERROR_PREFIX = "__BOT_HOST_COMMAND_SPAWN_ERROR__";
const HOST_COMMAND_TIMEOUT_PREFIX = "__BOT_HOST_COMMAND_TIMEOUT__";
