// Macos Discord script supports Bot repository automation.
...
${this.input.guestNode} ${this.input.guestBotEntry} config set channels.discord.token ${shellQuote(this.input.config.token)}
${this.input.guestNode} ${this.input.guestBotEntry} config set channels.discord.enabled true
${this.input.guestNode} ${this.input.guestBotEntry} config set channels.discord.groupPolicy allowlist
${this.input.guestNode} ${this.input.guestBotEntry} config set channels.discord.guilds ${shellQuote(guilds)} --strict-json
${this.input.guestNode} ${this.input.guestBotEntry} doctor --fix --yes --non-interactive
...
JS
${this.input.guestNode} ${this.input.guestBotEntry} plugins enable discord
${this.input.guestNode} ${this.input.guestBotEntry} gateway restart
${this.input.guestNode} ${this.input.guestBotEntry} channels status --probe --json`);
  }
