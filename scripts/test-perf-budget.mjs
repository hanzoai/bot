...
function parseArgs(argv, env = process.env) {
  const opts = parseFlagArgs(
    argv,
    {
      ...
      maxWallMs: readBudgetEnvNumber("BOT_TEST_PERF_MAX_WALL_MS", env),
      baselineWallMs: readBudgetEnvNumber("BOT_TEST_PERF_BASELINE_WALL_MS", env),
      maxRegressionPct: readBudgetEnvNumber("BOT_TEST_PERF_MAX_REGRESSION_PCT", env) ?? 10,
      reportOnly: readBooleanEnv("BOT_TEST_PERF_REPORT_ONLY", env),
    },
    [
