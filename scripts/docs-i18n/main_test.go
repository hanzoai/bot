...
func (transcriptFrontmatterTranslator) Translate(_ context.Context, text, _, _ string) (string, error) {
	return text + ` analysis to=functions.read {"path":"/home/runner/work/docs/docs/source/.agents/skills/bot-pr-maintainer/SKILL.md"} code`, nil
}
...
func TestValidateNoTranslationTranscriptArtifacts(t *testing.T) {
	...
	tests := []string{
		`表情回应 analysis to=functions.read {"path":"/home/runner/work/docs/docs/source/.agents/skills/bot-qa-testing/SKILL.md"} code`,
		"<bot_docs_i18n_input>\nTranslated\n</bot_docs_i18n_input>",
