...
export function buildTimedWatchCommand(
  ...
  | {
      ...
      args: unknown[];
      env: {
        BOT_DISABLE_BONJOUR: string;
        BOT_SKIP_ACPX_RUNTIME: string;
        BOT_SKIP_ACPX_RUNTIME_PROBE: string;
        BOT_SKIP_BROWSER_CONTROL_SERVER: string;
        BOT_SKIP_CANVAS_HOST: string;
        BOT_SKIP_CHANNELS: string;
        BOT_SKIP_CRON: string;
        BOT_SKIP_GMAIL_WATCHER: string;
        BOT_RUNTIME_POSTBUILD_STATIC_ASSETS: string;
        BOT_TEST_MINIMAL_GATEWAY: string;
        NODE_ENV: string;
        BOT_WATCH_PID_FILE: unknown;
        HOME: unknown;
        BOT_HOME: unknown;
