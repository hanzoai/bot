...
const pierreDiffsEmptySideEffectNamespace = "bot-diffs-empty-side-effect";
...
export function createPierreDiffsSideEffectImportPlugin() {
  return {
    name: "bot-diffs-pierre-side-effect-imports",
    setup(buildContext) {
...
async function buildDiffsViewerRuntime(targetName) {
  ...
  const result = await build({
    ...
    minify: true,
    define: {
      __BOT_DIFFS_LANGUAGE_PACK__: String(target.languagePackAvailable),
      NaN: "Number.NaN",
    },
    legalComments: "none",
    outfile: outputPath,
