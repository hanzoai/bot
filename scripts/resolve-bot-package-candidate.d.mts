...
export function validateBotPackageSpec(spec: unknown): void;
...
export const BOT_PACKAGE_SPEC_RE: RegExp;
...
export function cleanPackedBotTarballsForTest(outputDir: unknown): Promise<void>;
