...
import { buildBotReleaseClawHubRuntimeState } from "./lib/bot-release-clawhub-plan.ts";
...
try {
  const state = buildBotReleaseClawHubRuntimeState(parseArgs(process.argv.slice(2)));
