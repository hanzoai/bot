...
function ensureBotExtensionAlias(params) {
  ...
  const aliasDir = path.join(params.distExtensionsRoot, "node_modules", "bot");
...
function shouldCopyRuntimeFile(relativePath) {
  return (
    ...
    isPathOrNestedPath(relativePath, "bot.plugin.json") ||
...
export function stageBundledPluginRuntime(params = {}) {
  ...
  ensureBotExtensionAlias({ repoRoot, distExtensionsRoot });
