...
import { buildMessagingTarget, type MessagingTarget } from "bot/plugin-sdk/channel-targets";
import type { DirectoryConfigParams } from "bot/plugin-sdk/directory-runtime";
