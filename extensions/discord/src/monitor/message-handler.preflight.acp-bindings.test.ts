...
import * as conversationBindingRuntime from "bot/plugin-sdk/conversation-binding-runtime";
...
import { testing as sessionBindingTesting } from "bot/plugin-sdk/conversation-runtime";
  ...
  return {
    ...createDiscordPreflightArgs({
      ...
      discordConfig: {
        ...
        import("bot/plugin-sdk/config-contracts").BotConfig["channels"]
      >["discord"],
