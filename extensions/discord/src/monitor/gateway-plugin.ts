...
import { createNodeProxyAgent } from "bot/plugin-sdk/fetch-runtime";
import {
  captureWsEvent,
...
type ResolveDiscordGatewayIntentsParams = {
  intentsConfig?: import("bot/plugin-sdk/config-contracts").DiscordIntentsConfig;
...
function createGatewayPlugin(params: {
  ...
  class BotGatewayPlugin extends discordGateway.GatewayPlugin {
...
export function createDiscordGatewayPlugin(params: {
  ...
  return createGatewayPlugin({
    options: {
      ...
      intents,
      // Bot registers its own async interaction listener.
