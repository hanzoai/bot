import type { BotPluginApi, BotPluginService } from "bot/plugin-sdk/plugin-entry";
...
export function registerMxcPlugin(api: BotPluginApi): void {
  ...
  const cleanupService: BotPluginService = {
