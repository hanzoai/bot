...
function createApi(params?: {
  pluginConfig?: BotPluginApi["pluginConfig"];
  registerHttpRoute?: BotPluginApi["registerHttpRoute"];
  logger?: BotPluginApi["logger"];
}): BotPluginApi {
...
function requireFirstRouteRegistration(mock: ReturnType<typeof vi.fn>) {
  ...
  return call[0] as Parameters<BotPluginApi["registerHttpRoute"]>[0];
}
