// Webhooks plugin entrypoint registers its Bot integration.
...
function registerWebhookRoutes(api: BotPluginApi): void {
...
export default definePluginEntry({
  ...
  name: "Webhooks",
  description:
    "Authenticated inbound webhooks that bind external automation to Bot TaskFlows.",
