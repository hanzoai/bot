/**
 * Voice call response generator - uses the embedded Bot agent for tool support.
...
/**
 * Generate a voice response using the embedded Bot agent with full tool support.
