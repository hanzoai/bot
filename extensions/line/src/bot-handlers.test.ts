...
vi.mock("bot/plugin-sdk/channel-inbound", () => ({
  buildMentionRegexes: () => [],
  matchesMentionPatterns: () => false,
}));
vi.mock("bot/plugin-sdk/channel-pairing", () => ({
...
vi.mock("bot/plugin-sdk/command-auth-native", () => ({
...
vi.mock("bot/plugin-sdk/runtime-group-policy", () => ({
...
vi.mock("bot/plugin-sdk/routing", () => ({
...
describe("handleLineWebhookEvents", () => {
  ...
  afterAll(() => {
    vi.doUnmock("bot/plugin-sdk/channel-inbound");
    vi.doUnmock("bot/plugin-sdk/channel-pairing");
    vi.doUnmock("bot/plugin-sdk/command-auth-native");
    vi.doUnmock("bot/plugin-sdk/runtime-group-policy");
    vi.doUnmock("bot/plugin-sdk/runtime-env");
    vi.doUnmock("bot/plugin-sdk/reply-history");
    vi.doUnmock("bot/plugin-sdk/routing");
