...
import type { ConfiguredBindingRouteResult } from "bot/plugin-sdk/conversation-binding-runtime";
...
vi.mock("bot/plugin-sdk/conversation-binding-runtime", () => ({
...
vi.mock("bot/plugin-sdk/routing", async (importOriginal) => {
  const actual = await importOriginal<typeof import("bot/plugin-sdk/routing")>();
  return {
    ...actual,
