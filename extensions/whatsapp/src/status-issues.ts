    ...
    collectIssues: ({ account, accountId, issues }) => {
      ...
      if (
        ...
        issues.push({
          ...
          fix: `Watch: ${formatCliCommand("bot logs --follow")} and run ${formatCliCommand("bot channels status --probe")} if disconnects continue. If it keeps flapping, restart the gateway or relink via channels login.`,
        });
        return;
      }
