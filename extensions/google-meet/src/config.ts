...
import { buildMeetingSoxAudioCommands } from "bot/plugin-sdk/meeting-runtime";
import {
...
const GOOGLE_MEET_CLIENT_ID_KEYS = ["BOT_GOOGLE_MEET_CLIENT_ID", "GOOGLE_MEET_CLIENT_ID"];
