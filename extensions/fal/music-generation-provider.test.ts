...
import { expectExplicitMusicGenerationCapabilities } from "bot/plugin-sdk/provider-test-contracts";
...
vi.mock("bot/plugin-sdk/provider-http", async (importOriginal) => {
  const original = await importOriginal<typeof import("bot/plugin-sdk/provider-http")>();
  return {
    ...original,
