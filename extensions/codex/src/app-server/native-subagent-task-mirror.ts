/**
 * Mirrors Codex native subagent thread lifecycle events into Bot task
 * runtime rows so parent sessions can observe child progress.
 */
import type { AgentHarnessTaskRuntime } from "bot/plugin-sdk/agent-harness-task-runtime";
...
/** Converts a Codex child thread id into the Bot task-runtime run id. */
