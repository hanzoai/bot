/**
 * Projects Bot context-engine assemblies into Codex prompt text while
...
import { redactSensitiveFieldValue, redactToolPayloadText } from "bot/plugin-sdk/logging-core";
...
const CONTEXT_HEADER = "Bot assembled context for this turn:";
...
/** Projects assembled Bot context-engine messages into Codex prompt inputs. */
