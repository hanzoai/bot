// Codex tests cover bot owned tool runtime contract plugin behavior.
import type { AnyAgentTool } from "bot/plugin-sdk/agent-harness";
import { wrapToolWithBeforeToolCallHook } from "bot/plugin-sdk/agent-harness-runtime";
import {
...
describe("Bot-owned tool runtime contract — Codex app-server adapter", () => {
  afterEach(() => {
    resetBotOwnedToolHooks();
  });
