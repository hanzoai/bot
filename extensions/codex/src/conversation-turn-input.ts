...
import type { PluginHookInboundClaimEvent } from "bot/plugin-sdk/plugin-entry";
import { normalizeSingleOrTrimmedStringList } from "bot/plugin-sdk/string-coerce-runtime";
...
function extractInboundMedia(event: PluginHookInboundClaimEvent): InboundMedia[] {
  ...
  // Bot channels expose either local staged files or remote URLs. Keep
