...
import { buildOauthProviderAuthResult } from "bot/plugin-sdk/provider-auth-result";
import type { ProviderPlugin } from "bot/plugin-sdk/provider-model-shared";
import { fetchGeminiUsage } from "bot/plugin-sdk/provider-usage";
...
export function registerGoogleGeminiCliProvider(api: BotPluginApi) {
