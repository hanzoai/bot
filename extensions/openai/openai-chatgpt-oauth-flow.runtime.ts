...
import { parseOAuthAuthorizationInput } from "bot/plugin-sdk/provider-oauth-runtime";
 ...
 * @param options.originator - OAuth originator parameter (defaults to "bot")
 */
