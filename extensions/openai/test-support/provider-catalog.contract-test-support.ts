...
import type { ProviderPlugin } from "bot/plugin-sdk/provider-test-contracts";
...
vi.mock("bot/plugin-sdk/provider-catalog-runtime", async () => {
  const actual = await vi.importActual<
    typeof import("bot/plugin-sdk/provider-catalog-runtime")
  >("bot/plugin-sdk/provider-catalog-runtime");
