...
describe("Slack approval actions", () => {
  ...
  it.each([
    "callback",
    "bot:approval:v1:not-json",
    'bot:approval:v1:{"approvalId":"req-1","decision":"allow-once"}',
    'bot:approval:v1:{"approvalId":"req-1","approvalKind":"exec","decision":"accept"}',
    'bot:approval:v1:{"approvalId":"req-1","approvalKind":"exec","decision":"deny","extra":true}',
