...
import { stringEnum } from "bot/plugin-sdk/channel-actions";
import type { AnyAgentTool, BotPluginToolContext } from "bot/plugin-sdk/core";
import { formatErrorMessage } from "bot/plugin-sdk/error-runtime";
import { jsonResult as json, type AgentToolResult } from "bot/plugin-sdk/tool-results";
...
type ZalouserToolContext = Pick<BotPluginToolContext, "deliveryContext">;
