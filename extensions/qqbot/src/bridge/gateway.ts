...
import { resolveRuntimeServiceVersion } from "bot/plugin-sdk/cli-runtime";
...
initSender({
  pluginVersion,
  botVersion: resolveRuntimeServiceVersion(),
});
...
export async function startGateway(ctx: GatewayContext): Promise<void> {
  ...
  const getCurrentConfig = () => pluginRuntime.config.current() as BotConfig;
