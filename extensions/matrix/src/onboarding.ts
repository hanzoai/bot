...
import { isPrivateNetworkOptInEnabled } from "bot/plugin-sdk/ssrf-policy";
import {
...
async function configureMatrixInviteAutoJoin(params: {
  ...
  await params.prompter.note(
    [
      ...
      "Bot agents will not join invited rooms or fresh DM-style invites unless you set autoJoin.",
