...
import { createChannelApprovalNativeRuntimeAdapter } from "bot/plugin-sdk/approval-handler-runtime";
import { buildChannelApprovalNativeTargetKey } from "bot/plugin-sdk/approval-native-runtime";
import {
  buildExecApprovalPendingReplyPayload,
  buildPluginApprovalPendingReplyPayload,
  type ExecApprovalReplyDecision,
} from "bot/plugin-sdk/approval-reply-runtime";
import { buildPluginApprovalResolvedReplyPayload } from "bot/plugin-sdk/approval-runtime";
import type {
  ExecApprovalRequest,
...
import { normalizeUniqueStringEntries } from "bot/plugin-sdk/string-coerce-runtime";
import {
...
// Bot Matrix custom event content for capable clients; body and reactions remain fallback.
const MATRIX_APPROVAL_METADATA_KEY = "com.bot.approval" as const;
