// Matrix plugin entrypoint registers its Bot integration.
...
import { resolveOptionalIntegerOption } from "bot/plugin-sdk/number-runtime";
import {
...
type MonitorMatrixOpts = {
  ...
  setStatus?: (next: import("bot/plugin-sdk/channel-contract").ChannelAccountSnapshot) => void;
};
