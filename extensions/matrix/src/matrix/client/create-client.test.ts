...
describe("createMatrixClient", () => {
  const storagePaths = {
    rootDir: "/tmp/bot-matrix-create-client-test",
    storagePath: "/tmp/bot-matrix-create-client-test/storage.json",
    recoveryKeyPath: "/tmp/bot-matrix-create-client-test/recovery.key",
    idbSnapshotPath: "/tmp/bot-matrix-create-client-test/idb.snapshot",
    accountKey: "default",
  ...
  it("persists storage metadata by default", async () => {
    ...
    expect(MatrixClientMock).toHaveBeenCalledWith("https://matrix.example.org", "tok", {
      ...
      cryptoDatabasePrefix: "bot-matrix-default-token-hash",
