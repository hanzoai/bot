...
import { hasConfiguredSecretInput } from "bot/plugin-sdk/secret-input-runtime";
...
export function resolveMatrixChannelConfig(cfg: BotConfig): Record<string, unknown> | null {
