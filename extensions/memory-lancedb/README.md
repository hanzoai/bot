# @hanzo/bot-memory-lancedb

Official LanceDB-backed long-term memory plugin for Bot.
...
- https://docs.bot.ai/plugins/memory-lancedb

## Package

- Plugin id: `memory-lancedb`
- Package: `@hanzo/bot-memory-lancedb`
