// Feishu plugin entrypoint registers its Bot integration.
import {
...
function registerFeishuDocTools(api: BotPluginApi) {
...
function registerFeishuChatTools(api: BotPluginApi) {
  const register = loadBundledEntryExportSync<(api: BotPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
...
function registerFeishuWikiTools(api: BotPluginApi) {
  const register = loadBundledEntryExportSync<(api: BotPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
...
function registerFeishuDriveTools(api: BotPluginApi) {
  const register = loadBundledEntryExportSync<(api: BotPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
...
function registerFeishuPermTools(api: BotPluginApi) {
  const register = loadBundledEntryExportSync<(api: BotPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
...
function registerFeishuBitableTools(api: BotPluginApi) {
  const register = loadBundledEntryExportSync<(api: BotPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
