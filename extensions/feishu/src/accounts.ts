import type { Hanzo BotConfig } from "bot/plugin-sdk";
 ...
 */
export function listFeishuAccountIds(cfg: Hanzo BotConfig): string[] {
 ...
 */
export function resolveDefaultFeishuAccountId(cfg: Hanzo BotConfig): string {
 ...
 */
function mergeFeishuAccountConfig(cfg: Hanzo BotConfig, accountId: string): FeishuConfig {
 ...
 */
export function listEnabledFeishuAccounts(cfg: Hanzo BotConfig): ResolvedFeishuAccount[] {
