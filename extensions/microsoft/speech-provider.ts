...
import { isVoiceMessageCompatibleAudio } from "bot/plugin-sdk/media-runtime";
import {
...
import { asBoolean, asFiniteNumber, asObject, trimToUndefined } from "bot/plugin-sdk/speech";
import {
  fetchWithSsrFGuard,
