...
const DOCTOR_FIX_COMMAND = "bot doctor --fix";

async function collectPreviewWarnings(cfg: BotConfig, env?: NodeJS.ProcessEnv) {
...
async function repairConfig(cfg: BotConfig) {
...
vi.mock("bot/plugin-sdk/runtime", () => {
  return {
