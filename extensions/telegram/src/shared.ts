...
import { resolveNormalizedAccountEntry } from "bot/plugin-sdk/account-core";
...
import { createChannelPluginBase, type ChannelPlugin } from "bot/plugin-sdk/channel-core";
import { getChatChannelMeta } from "bot/plugin-sdk/channel-plugin-common";
 ...
 *
 * See: https://github.com/hanzoai/bot/issues/53876
 */
function isBlockedByMultiBotGuard(cfg: BotConfig, accountId: string): boolean {
