...
import type { AnyAgentTool, BotPluginToolFactory } from "bot/plugin-sdk/plugin-entry";
...
function registerMemoryCoreToolFactories(
  appConfig: BotConfig,
): Map<string, BotPluginToolFactory> {
...
function createMemoryCoreTool(params: {
  factories: Map<string, BotPluginToolFactory>;
