...
import { FsSafeError } from "bot/plugin-sdk/security-runtime";
...
vi.mock("bot/plugin-sdk/security-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("bot/plugin-sdk/security-runtime")>();
  return {
    ...actual,
