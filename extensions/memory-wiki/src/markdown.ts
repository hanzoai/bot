...
export const WIKI_RELATED_START_MARKER = "<!-- bot:wiki:related:start -->";
export const WIKI_RELATED_END_MARKER = "<!-- bot:wiki:related:end -->";
export const WIKI_RAW_SOURCE_MARKER = "<!-- bot:wiki:raw-source -->";
...
const HUMAN_START_MARKER = "<!-- bot:human:start -->";
const HUMAN_END_MARKER = "<!-- bot:human:end -->";
