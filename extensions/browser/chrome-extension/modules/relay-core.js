// Pure helpers for the Bot extension: pairing-string parsing, reconnect
...
export const BOT_TAB_GROUP_TITLE = "Bot";
...
/**
 * Parse a pairing string printed by `bot browser extension pair`.
