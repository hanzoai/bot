...
let tmpDirModule: typeof import("../infra/tmp-bot-dir.js");
...
describe("pw-tools-core", () => {
  ...
  beforeAll(async () => {
    ...
    tmpDirModule = await import("../infra/tmp-bot-dir.js");
    vi.spyOn(tmpDirModule, "resolvePreferredBotTmpDir").mockImplementation(
      tmpDirMocks.resolvePreferredBotTmpDir,
    );
  ...
  it.runIf(process.platform !== "win32")(
    ...
    async () => {
      await withTempDir(async (tempDir) => {
        ...
        tmpDirMocks.resolvePreferredBotTmpDir.mockReturnValue(tempDir);
