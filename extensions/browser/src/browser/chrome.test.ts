...
describe("browser chrome helpers", () => {
  ...
  it("stopBotChrome asks Chrome to close gracefully before sending a signal", async () => {
  ...
  it("stopBotChrome escalates when graceful close leaves CDP reachable", async () => {
