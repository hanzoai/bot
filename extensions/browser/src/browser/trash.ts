...
import { movePathToTrash as movePathToTrashWithAllowedRoots } from "bot/plugin-sdk/browser-config";
...
export async function movePathToTrash(targetPath: string): Promise<string> {
  return await movePathToTrashWithAllowedRoots(targetPath, {
    // Managed browser data follows BOT_STATE_DIR/BOT_CONFIG_PATH, which
