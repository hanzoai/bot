...
const volatileStateSymbol = Symbol.for("bot.browser.session-tabs.volatile");
const activeDurableStateSymbol = Symbol.for("bot.browser.session-tabs.active-durable-keys");
