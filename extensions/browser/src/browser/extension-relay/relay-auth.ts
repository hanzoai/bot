 ...
 *
 * The relay authenticates the loopback link between Bot and the paired
...
} from "bot/plugin-sdk/secret-file";
 ...
 * startup and `bot browser extension pair` — both run on the machine that
