...
import { root as fsRoot } from "bot/plugin-sdk/file-access-runtime";
import type {
  SandboxFsBridge,
  SandboxFsStat,
  SandboxResolvedPath,
} from "bot/plugin-sdk/sandbox";
import { createWritableRenameTargetResolver } from "bot/plugin-sdk/sandbox";
import { FsSafeError, isPathInside } from "bot/plugin-sdk/security-runtime";
...
const MATERIALIZED_SKILLS_CONTAINER_PARTS = [".bot", "sandbox-skills", "skills"] as const;
