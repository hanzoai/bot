...
import { expectProvidedCfgSkipsRuntimeLoad } from "bot/plugin-sdk/channel-test-helpers";
...
vi.mock("bot/plugin-sdk/plugin-config-runtime", () => ({
...
vi.mock("bot/plugin-sdk/markdown-table-runtime", () => ({
