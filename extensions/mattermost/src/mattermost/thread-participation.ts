...
import { createPersistentDedupeCache } from "bot/plugin-sdk/dedupe-runtime";
 ...
 */
const MATTERMOST_THREAD_PARTICIPATION_KEY = Symbol.for("bot.mattermostThreadParticipation");
