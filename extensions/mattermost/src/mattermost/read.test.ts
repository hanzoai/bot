...
describe("readMattermostMessages", () => {
  ...
  it("allows a configured delegated cross-channel read", async () => {
    const cfg = createMattermostTestConfig("read-configured") as BotConfig;
  ...
  it("allows an unlisted member channel only when groupPolicy is open", async () => {
    const cfg = createMattermostTestConfig("read-open") as BotConfig;
  ...
  it.each([
    ...
    const cfg = createMattermostTestConfig("read-named-inheritance") as BotConfig;
  ...
  it("rejects disabled accounts before provider access", async () => {
    const cfg = createMattermostTestConfig("read-disabled") as BotConfig;
