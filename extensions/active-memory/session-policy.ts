...
import { resolveRememberAcrossConversations } from "bot/plugin-sdk/memory-core-host-runtime-core";
import {
  normalizePluginsConfig,
  resolvePluginConfigObject,
} from "bot/plugin-sdk/plugin-config-runtime";
import type { BotPluginApi } from "bot/plugin-sdk/plugin-entry";
import { parseAgentSessionKey, parseThreadSessionSuffix } from "bot/plugin-sdk/routing";
...
function openActiveMemoryToggleStore(api: BotPluginApi) {
...
function isActiveMemoryGloballyEnabled(cfg: BotConfig): boolean {
...
function isActiveMemoryPluginEnabled(cfg: BotConfig): boolean {
...
function hasRememberAcrossConversationsAgent(cfg: BotConfig): boolean {
...
function shouldRememberAcrossConversations(cfg: BotConfig, agentId: string): boolean {
