...
export const legacyConfigRules: LegacyConfigRule[] = [
  {
    ...
    message:
      'models.providers.ollama-cloud.baseUrl="https://ai.ollama.com" is retired; use "https://ollama.com". Run "bot doctor --fix".',
    match: (value) => findRetiredOllamaCloudBaseUrl(value) !== null,
  },
];

function migrateOllamaCloudRetiredBaseUrl(config: BotConfig): {
  config: BotConfig;
  changes: string[];
} | null {
  ...
  nextConfig.models = nextModels as BotConfig["models"];
