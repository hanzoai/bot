...
import { transcodeAudioBufferToOpus } from "bot/plugin-sdk/media-runtime";
import {
...
import { asFiniteNumberInRange } from "bot/plugin-sdk/string-coerce-runtime";
import {
...
function resolveConfiguredPortalTtsBaseUrl(cfg: BotConfig | undefined): string | undefined {
