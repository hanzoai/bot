...
import type { ProviderAuthContext, ProviderAuthMethod } from "bot/plugin-sdk/plugin-entry";
import {
  ...
  try {
    ...
    return buildOauthProviderAuthResult({
      ...
      notes: [
        ...
        "xAI may label the consent app as Grok Build because Bot uses xAI's shared OAuth client.",
      ],
    });
  } catch (err) {
