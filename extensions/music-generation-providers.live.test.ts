...
const providerFilter = parseCsvFilter(process.env.BOT_LIVE_MUSIC_GENERATION_PROVIDERS);
const envModelMap = parseProviderModelMap(process.env.BOT_LIVE_MUSIC_GENERATION_MODELS);
