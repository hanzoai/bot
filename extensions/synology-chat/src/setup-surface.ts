...
function getChannelConfig(cfg: BotConfig): SynologyChatChannelConfig {
  return (cfg.channels?.[channel] as SynologyChatChannelConfig | undefined) ?? {};
}

function getRawAccountConfig(cfg: BotConfig, accountId: string): SynologyChatAccountRaw {
...
function isSynologyChatConfigured(cfg: BotConfig, accountId: string): boolean {
...
function resolveExistingAllowedUserIds(cfg: BotConfig, accountId: string): string[] {
