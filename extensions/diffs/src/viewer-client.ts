...
declare const __BOT_DIFFS_LANGUAGE_PACK__: boolean | undefined;

// Build-time esbuild define; typeof guard keeps the module loadable where the
// define is absent (vitest/node), matching the __BOT_VERSION__ pattern.
function readInjectedLanguagePackFlag(): boolean | undefined {
  return typeof __BOT_DIFFS_LANGUAGE_PACK__ === "boolean"
    ? __BOT_DIFFS_LANGUAGE_PACK__
    : undefined;
}
