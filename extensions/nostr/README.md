...
Nostr DM channel plugin for Bot using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Bot. It enables your bot to:
...
# Configure bot to use local relay
