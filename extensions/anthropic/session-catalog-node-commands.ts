...
export function createClaudeSessionNodeHostCommands(): BotPluginNodeHostCommand[] {
  return [
    {
...
export function createClaudeSessionNodeInvokePolicies(): BotPluginNodeInvokePolicy[] {
  return [
    {
      commands: [
        CLAUDE_SESSIONS_LIST_COMMAND,
