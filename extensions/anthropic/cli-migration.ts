...
type AgentDefaultsModel = NonNullable<NonNullable<BotConfig["agents"]>["defaults"]>["model"];
type AgentDefaultsModels = NonNullable<NonNullable<BotConfig["agents"]>["defaults"]>["models"];
