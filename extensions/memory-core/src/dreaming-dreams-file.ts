...
import { replaceManagedMarkdownBlock } from "bot/plugin-sdk/memory-host-markdown";
import { readRegularFile, replaceFileAtomic } from "bot/plugin-sdk/security-runtime";

const DREAMS_FILENAMES = ["DREAMS.md", "dreams.md"] as const;
const DEEP_START_MARKER = "<!-- bot:dreaming:deep:start -->";
const DEEP_END_MARKER = "<!-- bot:dreaming:deep:end -->";
