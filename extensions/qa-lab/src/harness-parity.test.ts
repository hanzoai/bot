...
const LEFT: HarnessVariant = { id: "left", label: "Left", runtime: "bot" };
const RIGHT: HarnessVariant = { id: "right", label: "Right", runtime: "bot" };
