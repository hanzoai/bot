...
import { withTrustedWebSearchEndpoint } from "bot/plugin-sdk/provider-web-search";
...
// without this, undici sends a generic `node` UA and Bot usage is only
  ...
  const init = await postMcp({
    ...
    body: {
      ...
      params: {
        ...
        capabilities: {},
        clientInfo: { name: "bot-parallel", version: PLUGIN_VERSION },
      },
    },
  });
  if (!init.ok) {
