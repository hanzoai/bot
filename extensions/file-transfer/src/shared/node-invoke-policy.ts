...
type PreflightResult =
  ...
  | {
      ok: false;
      result: BotPluginNodeInvokePolicyResult;
    };
...
async function handleFileTransferInvoke(
  ctx: BotPluginNodeInvokePolicyContext,
): Promise<BotPluginNodeInvokePolicyResult> {
...
export function createFileTransferNodeInvokePolicy(): BotPluginNodeInvokePolicy {
  return {
