# GitHub Copilot agent runtime (Bot plugin)

External Bot plugin that registers a `copilot` agent harness backed by `@github/copilot-sdk` and the GitHub Copilot CLI.
...
entry; `auto` never picks it. Bot remains the default embedded runtime.
