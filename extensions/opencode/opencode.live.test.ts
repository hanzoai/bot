...
import { extractNonEmptyAssistantText, isLiveTestEnabled } from "bot/plugin-sdk/test-live";
...
const LIVE_MODEL_ID =
  process.env.BOT_LIVE_OPENCODE_DEEPSEEK_MODEL?.trim() || "deepseek-v4-flash-free";
