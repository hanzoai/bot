...
- **X/Twitter:** [@bot](https://x.com/bot)

## Maintainers

The current Bot Foundation team and Core Maintainers are listed on the
Bot people page: https://www.bot.org/people

## How to Contribute

1. **Bugs & small fixes** → Open a PR!
2. **New features / architecture** → Start a [GitHub Issue](https://github.com/hanzoai/bot/issues/new/choose) or ask in Discord first. Most features are not accepted and should be third party plugins instead using our plugin SDK.
...
| -------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------- |
| Product bug, regression, crash, or behavior defect       | [Bug report](https://github.com/hanzoai/bot/issues/new?template=bug_report.yml)                                                                                                | Repro steps, expected vs actual behavior, version, OS, model/provider route when relevant, logs/screenshots, impact |
| Documentation bug or missing/contradictory docs          | [Docs bug report](https://github.com/hanzoai/bot/issues/new?template=docs_bug_report.yml)                                                                                      | Affected docs path or URL, verification steps, expected docs content, actual docs content, impact, evidence         |
| New feature, architecture change, or product improvement | [Feature request](https://github.com/hanzoai/bot/issues/new?template=feature_request.yml) or Discord first                                                                     | Problem, proposed solution, alternatives, impact, examples or prior art                                             |
...
- Do not edit `CHANGELOG.md` in contributor PRs. Maintainers or BotSweeper add the changelog entry when landing user-facing changes.
...
- If you are using an AI coding agent with Bot skills available, run the `autoreview` skill before opening or updating your PR. Address accepted/actionable findings before asking for review.
...
After your PR receives Barnacle, BotSweeper, or maintainer feedback, read the [pull request review flow](https://docs.bot.ai/reference/pull-request-review-flow) for how to interpret rank-up moves, proof guidance, re-review requests, and review conversation follow-up.
...
- [ ] Follow the [pull request review flow](https://docs.bot.ai/reference/pull-request-review-flow) after Barnacle, BotSweeper, or maintainer feedback
...
Check the [GitHub Issues](https://github.com/hanzoai/bot/issues) for
["good first issue"](https://github.com/hanzoai/bot/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22)
...
Still interested? Email contributing@bot.ai with:
...
For issues that don't fit a specific repo, or if you're unsure, email **security@bot.ai** and we'll route it.
