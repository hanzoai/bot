...
- Bot currently projects many of these events into user-visible thread messages.
...
- Apply dedupe/throttle/filter only in Bot ACP projection before channel delivery.
...
- In scope:
  - ACP message projection/filtering in Bot.
