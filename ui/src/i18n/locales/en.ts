...
export const en: TranslationMap = {
  ...
  lazyView: {
    ...
    staleSubtitle: "Bot was updated in the background. Reload to get the latest panel.",
    reloading: "Reloading…",
    retry: "Retry",
  },
  nodes: {
    pairing: {
      ...
      qrAlt: "Bot mobile pairing QR code",
      ...
      review: "Review",
      waiting: "Official Bot mobile apps connect automatically after scanning.",
      help: "Pairing help",
  ...
  worktrees: {
    ...
    subtitle: "Isolated repository checkouts owned by Bot.",
    cleanNow: "Clean up now",
    cleanupTitle: "Cleanup",
    cleanupSubtitle:
      "Bot periodically removes old worktrees to free disk space. Tune how aggressively cleanup runs.",
  ...
  newSession: {
    ...
    cloudRequiresBotRuntime:
      "Cloud workers require the Bot runtime; {runtime} is selected.",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeHint: "Notifications are shown natively by the Bot app on this Mac.",
      ...
      nativeBlockedHint:
        "Notifications are disabled for Bot in macOS. Allow them in System Settings > Notifications.",
    },
    appearance: {
      theme: "Theme",
    ...
    retry: "Retry",
    applyBannerText: "Saved to bot.json — restart the gateway to apply.",
  ...
  modelSetup: {
    ...
    intro:
      "Bot reuses AI access you already have — a CLI login, an API key, or a provider sign-in.",
    ...
    access: {
      ...
      gatewayTooOld: "The Gateway is running an older Bot version",
    },
    candidates: {
  ...
  memoryImport: {
    ...
    confirmBackup: "Bot creates a verified pre-import backup before copying memory.",
    confirmImport: "Import memory",
    disconnected: "Connect to the gateway to import memory.",
    title: "Import assistant memory",
    subtitle:
      "Review Codex consolidated memory and Claude Code auto-memory before copying it into Bot.",
  ...
  onboarding: {
    memoryImport: {
      ...
      body: "Bot found memory from other coding assistants. Import it into your agent workspace?",
      ...
      doneBody: "Migrated {migrated}, skipped {skipped}. You can continue setting up Bot.",
    },
  },
  custodian: {
    title: "Bot",
    ...
    earlier: "Earlier",
    requestFailed: "Bot could not reply. Try again.",
    connectionChanged: "The Gateway connection changed. Retry to continue this setup.",
    sessionRestarted:
      "{error} Bot started a fresh session; earlier messages remain for context.",
    unsupportedGateway: "Update the Gateway to continue setup with Bot.",
    panel: {
      title: "Bot",
      toggle: "Ask Bot",
      close: "Close Ask Bot",
      resize: "Resize Ask Bot",
      dockBottom: "Dock Ask Bot at bottom",
      dockRight: "Dock Ask Bot at right",
    },
    history: {
      button: "History",
      ...
      requestFailed: "Bot could not load change history.",
      loadMore: "Load more",
  ...
  talkPage: {
    ...
    gptLive: {
      title: "GPT-Live",
      hint: "GPT-Live works with a ChatGPT subscription: sign in once with “bot models auth login --provider openai”. No Platform API key needed. Browser Talk only. Delegated work runs under the agent's standard approval policy; the spoken-confirmation gate does not apply to GPT-Live yet.",
      ready: "Ready",
    },
  },
  memoryPage: {
    ...
    backend: {
      ...
      builtin: "Built-in",
      qmd: "QMD",
      builtinHint: "Memory files are indexed and searched by Bot itself.",
  ...
  pluginsPage: {
    ...
    noInstalledBody: "Discover a featured plugin or search ClawHub to extend Bot.",
    ...
    optionalCapability: "Optional Bot capability.",
    enabled: "Enabled",
    disabled: "Disabled",
    available: "Available",
  ...
  appsPage: {
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Chat, talk, approve actions, and share into Bot from iOS.",
      },
      android: {
        title: "Android",
        desc: "Your Android phone as a full Bot node — chat, camera, and Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
      ...
      wearOs: {
        title: "Wear OS",
        desc: "The Android companion extends Bot to your watch.",
      },
      macos: {
        title: "macOS",
      ...
      windows: {
        title: "Windows",
        desc: "The Windows companion connects your PC as an Bot node.",
      },
      linux: {
        title: "Linux",
      ...
      chrome: {
        ...
        desc: "Let Bot drive your existing Chrome — tabs, pages, and forms.",
      },
      plugins: {
        title: "Plugins & ClawHub",
        desc: "Extend Bot with channels, tools, and skills from the community.",
      },
    },
  },
  presence: {
  ...
  skillWorkshop: {
    ...
    selfLearning: {
      ...
      pitchBody:
        "Bot reviews corrections and substantial completed runs, then drafts skill proposals for this board. It spends extra background tokens and drafts arrive as pending proposals.",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Paste the token from bot dashboard --no-open or enter the configured password.",
        stepGenerate:
          "If no token is configured, run bot doctor --generate-gateway-token on the gateway host.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Run bot dashboard --no-open and open the fresh URL or paste its token.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Run bot devices list on the Gateway host.",
        stepApproveId: "Approve this request: bot devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Reopen the served dashboard with bot dashboard so the UI and Gateway come from the same install.",
        stepDevUi:
          "If using pnpm ui:dev, rebuild or restart the dev UI against the current checkout.",
        stepRestart:
          "Restart the Gateway after updating Bot so it serves the current protocol.",
      },
      network: {
        title: "Could not connect",
        summary:
          "The browser could not complete the Gateway connection. Check the target and transport before retrying credentials.",
        stepGateway: "Confirm the Gateway is running with bot status or bot gateway run.",
        stepUrl:
          "Check the WebSocket URL and use wss:// when the Gateway is behind HTTPS/Tailscale Serve.",
        stepDashboard:
          "Reopen the dashboard with bot dashboard --no-open to recopy the current URL and auth details.",
      },
    },
  },
  chat: {
    ...
    workspaceConflict: {
      ...
      description:
        "Bot kept your local versions and applied the other cloud changes. Inspect the staged result or take its version for a conflicted path.",
      ...
      commandsUnavailable:
        "This filename contains terminal control characters, so Bot will not build a copyable shell command for it. Inspect the staged ref directly and enter the path manually with care.",
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint: "Describe what Bot should do and when — it runs on schedule.",
    ...
    detail: {
      ...
      newSubtitle: "Describe what Bot should do, then pick when it runs.",
    ...
    form: {
      ...
      promptPlaceholder: "Describe what Bot should do...",
      repeat: "Repeat",
