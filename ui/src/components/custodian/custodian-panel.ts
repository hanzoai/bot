...
const panelLayout = createDockPanelLayout({
  storageKey: "bot.custodian.panel.v1",
  minHeight: 240,
  minWidth: 320,
  defaultDock: "right",
...
export class BotCustodianPanel extends BotLightDomElement {
...
if (!customElements.get("bot-custodian-panel")) {
  customElements.define("bot-custodian-panel", BotCustodianPanel);
}

declare global {
  interface HTMLElementTagNameMap {
    "bot-custodian-panel": BotCustodianPanel;
  }
}
