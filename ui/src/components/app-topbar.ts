...
class AppTopbar extends BotLightDomContentsElement {
    ...
    return html`
      ...
      >
        <div class="topnav-shell">
          <bot-tooltip .content=${drawerLabel}>
            <button
              type="button"
          ...
          <div class="topnav-shell__content" @mousedown=${beginNativeWindowDrag}>
            <div class="topbar-brand" aria-label="Bot">
              <img
                ...
                aria-hidden="true"
              />
              <span class="topbar-brand__title">Bot</span>
            </div>
          </div>
          <div class="topnav-shell__actions">
            <bot-tooltip .content=${t("chat.commandPaletteTitle")}>
              <button
                class="topbar-search"
...
if (!customElements.get("bot-app-topbar")) {
  customElements.define("bot-app-topbar", AppTopbar);
}
