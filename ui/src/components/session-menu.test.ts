...
async function mountMenu(
  ...
  const element = container.querySelector("bot-session-menu") as SessionMenuElement | null;
  if (!element) {
...
describe("session menu", () => {
  ...
  it("dispatches open-pr with the resolved URL from click or the G shortcut", async () => {
    const url = "https://github.com/hanzoai/bot/pull/12345";
