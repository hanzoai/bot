...
export class BotFilePreviewModal extends BotLitElement {
  ...
  override render() {
    ...
    return html`
      <bot-modal-dialog
        label=${label}
        style="--bot-modal-width: min(1100px, 92vw); --bot-modal-max-height: 86vh;"
...
declare global {
  interface HTMLElementTagNameMap {
    "bot-file-preview-modal": BotFilePreviewModal;
  }
}
