...
export class NativeLinkMenu extends BotLightDomElement {
...
if (!customElements.get("bot-native-link-menu")) {
  customElements.define("bot-native-link-menu", NativeLinkMenu);
}
