...
const ONBOARDING_MEMORY_IMPORT_KEY = "bot.onboarding.memory-import";
...
class OnboardingMemoryImport extends BotLightDomElement {
...
if (!customElements.get("bot-onboarding-memory-import")) {
  customElements.define("bot-onboarding-memory-import", OnboardingMemoryImport);
}

declare global {
  interface HTMLElementTagNameMap {
    "bot-onboarding-memory-import": OnboardingMemoryImport;
  }
}
