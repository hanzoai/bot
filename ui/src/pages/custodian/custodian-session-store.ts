import type { SystemAgentChatParams, SystemAgentChatResult } from "@hanzo/bot-gateway-protocol";
...
export class CustodianSessionStore {
  ...
  private async refreshTranscriptHistory(
    ...
    if (
      !context ||
      isGatewayMethodAdvertised(context.gateway.snapshot, "bot.chat.history") !== true
    ) {
      return;
    }
