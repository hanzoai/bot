...
class AgentMemoryPanel extends BotLightDomElement {
...
if (!customElements.get("bot-agent-memory-panel")) {
  customElements.define("bot-agent-memory-panel", AgentMemoryPanel);
}
