...
export class ConnectionPage extends BotLightDomElement {
...
if (!customElements.get("bot-connection-page")) {
  customElements.define("bot-connection-page", ConnectionPage);
}
