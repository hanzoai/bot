...
class TalkSettingsPage extends BotLightDomElement {
  ...
  /**
   * The GPT-Live setup this page advertises runs `bot models auth login`
...
if (!customElements.get("bot-talk-settings")) {
  customElements.define("bot-talk-settings", TalkSettingsPage);
}
