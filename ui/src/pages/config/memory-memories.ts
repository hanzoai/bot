...
class MemoryMemoriesElement extends BotLightDomElement {
...
if (!customElements.get("bot-memory-memories")) {
  customElements.define("bot-memory-memories", MemoryMemoriesElement);
}
