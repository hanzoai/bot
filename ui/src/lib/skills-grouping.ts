...
const SKILL_SOURCE_GROUPS: Array<{ id: string; labelKey: string; sources: string[] }> = [
  { id: "workspace", labelKey: "skillGroups.workspace", sources: ["bot-workspace"] },
  { id: "built-in", labelKey: "skillGroups.builtIn", sources: ["bot-bundled"] },
  { id: "installed", labelKey: "skillGroups.installed", sources: ["bot-managed"] },
  { id: "extra", labelKey: "skillGroups.extra", sources: ["bot-extra"] },
];
