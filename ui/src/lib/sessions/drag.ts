...
export const SESSION_DRAG_MIME = "application/x-bot-session-key";
const SIDEBAR_SECTION_DRAG_MIME = "application/x-bot-session-group";
const SIDEBAR_ROUTE_DRAG_MIME = "application/x-bot-sidebar-route";
