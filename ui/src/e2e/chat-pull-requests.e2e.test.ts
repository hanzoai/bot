...
describeControlUiE2e("session pull request chips", () => {
  ...
  it("pins detected PR chips above the composer with rate-limit staleness", async () => {
        ...
        "controlUi.sessionPullRequests": {
          pullRequests: [
            ...
            },
            {
              ...
              url: "https://github.com/hanzoai/bot/pull/103438",
              state: "merged",
            },
            {
              number: 103200,
              ...
              url: "https://github.com/hanzoai/bot/pull/103200",
              state: "merged",
            },
          ],
          rateLimited: true,
    ...
    await expect
      ...
      .toBe("https://github.com/hanzoai/bot/pull/103469/checks");
  ...
  it("offers a Create PR row with the stale warning while rate limited pre-PR", async () => {
    ...
    await expect.poll(() => row.locator(".chat-pr__repo").textContent()).toBe("bot");
    await expect
    ...
    await expect
      ...
      .toBe("https://github.com/hanzoai/bot/pull/new/claude/cloud-workers-live-events");
