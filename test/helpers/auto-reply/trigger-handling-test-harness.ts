...
const embeddedAgentMocks = getSharedMocks("bot.trigger-handling.embedded-agent-mocks", () => ({
...
const modelCatalogMocks = getSharedMocks("bot.trigger-handling.model-catalog-mocks", () => ({
...
const modelFallbackMocks = getSharedMocks("bot.trigger-handling.model-fallback-mocks", () => ({
...
const webSessionMocks = getSharedMocks("bot.trigger-handling.web-session-mocks", () => ({
