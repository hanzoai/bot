  ...
  it("compiles macOS catalogs into app-bundle localization directories", async () => {
    ...
    try {
      ...
      expect(frenchInfoPlist).toContain(
        '"NSUserNotificationUsageDescription" = "Bot a besoin de l’autorisation d’envoyer des notifications pour afficher des alertes concernant les actions de l’agent.";',
      );
