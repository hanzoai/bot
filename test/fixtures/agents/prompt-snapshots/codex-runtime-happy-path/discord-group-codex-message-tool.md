...
```json
{"chat_id":"channel:987654321","message_id":"discord-msg-0001","conversation_label":"Bot/#agent-sandbox","sender":{"id":"424242","name":"Pash","username":"pash"},"group_subject":"Bot maintainers","group_channel":"#agent-sandbox","group_space":"Bot","is_group_chat":true,"was_mentioned":true,"history_count":2}
```

Chat history since last reply: ⟦bot:ctx⟧
Peter: I pushed the Discord-side message-tool bridge.
Pash: @Bot please verify the Codex happy path too.
