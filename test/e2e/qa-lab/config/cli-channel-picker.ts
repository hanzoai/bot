...
async function runRealPicker(options: ProducerOptions, botHome: string) {
  ...
  const child = spawn(
    ...
    [
      ...
      path.join(botHome, "picker.raw.log"),
      process.execPath,
      "bot.mjs",
      "configure",
      "--section",
