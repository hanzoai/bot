      ...
      messages: [
        {
          ...
          __bot: { id: "shared-assistant-1", seq: 2 },
        },
      ],
    });
      ...
      messages: [
        {
          ...
          __bot: { id: "current-history-user", seq: 2 },
        },
        {
          role: "assistant",
          content: "Current branch reply",
          __bot: { id: "current-assistant", seq: 4 },
        },
      ],
    });
      ...
      messages: [
        {
          ...
          __bot: { id: "shared-user-2", seq: 1 },
        },
        {
          role: "assistant",
          content: "Persisted reply",
          __bot: { id: "shared-assistant-2", seq: 2 },
        },
      ],
    });
      ...
      messages: [
        {
          role: "assistant",
          content: "Current branch reply",
          __bot: { id: "imported-live-reply", seq: 3 },
        },
      ],
    });
      ...
      messages: [
        {
          ...
          __bot: { id: "other-assistant", seq: 2 },
        },
      ],
    });
    ...
    deferredHistory.resolve({
      ...
      messages: [
        ...Array.from({ length: 18 }, (_, index) => ({
          ...
          __bot: { id: `history-user-${index + 1}`, seq: index + 1 },
        })),
        {
          role: "assistant",
          content: "Reply at the scrollback limit",
          __bot: { id: "scrollback-assistant", seq: 20 },
        },
      ],
    });
