...
import type { BotStateDatabaseOptions } from "./bot-state-db-contract.js";
import { ensureAgentDatabaseLeaseSchema } from "./bot-state-db-schema-additive.js";
...
export function claimBotAgentDatabaseLease(params: {
  agentId: string;
  path: string;
...
export function releaseBotAgentDatabaseLease(
  leaseId: string,
...
export function assertNoBotAgentDatabaseLeases(
  agentIdRaw: string,
  options: BotStateDatabaseOptions = {},
): void {
