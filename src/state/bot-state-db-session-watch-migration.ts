...
import { ensureColumn, tableExists, tableHasColumn } from "./bot-state-db-schema-helpers.js";
...
type SessionWatchCursorDatabase = Pick<BotStateKyselyDatabase, "session_watch_cursors">;
