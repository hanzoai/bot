// Removes transient runtime state from restorable Bot database snapshots.
...
type SnapshotSanitizerDatabase = Pick<BotStateKyselyDatabase, "exec_approvals_config">;
...
export function sanitizeBotStateLeaseRows(database: DatabaseSync): void {
...
export function sanitizeBotGlobalStateSnapshot(database: DatabaseSync): void {
