// Bundled Bot provider index advertises pre-install provider metadata for model picker discovery.
import type { BotProviderIndex } from "./types.js";

// Bot-owned preview metadata for providers whose plugins may not be
...
export const BOT_PROVIDER_INDEX = {
  version: 1,
  providers: {
    moonshot: {
      id: "moonshot",
