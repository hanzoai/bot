...
export type BotProviderIndexPluginInstall = {
  clawhubSpec?: string;
  npmSpec?: string;
...
export type BotProviderIndexPlugin = {
  id: string;
  package?: string;
  source?: string;
  install?: BotProviderIndexPluginInstall;
};

export type BotProviderIndexProviderAuthChoice = {
  method: string;
  choiceId: string;
  choiceLabel: string;
  choiceHint?: string;
...
export type BotProviderIndexProvider = {
  id: string;
  name: string;
  plugin: BotProviderIndexPlugin;
  docs?: string;
  categories?: readonly string[];
  authChoices?: readonly BotProviderIndexProviderAuthChoice[];
  previewCatalog?: ModelCatalogProvider;
};

export type BotProviderIndex = {
  version: number;
  providers: Readonly<Record<string, BotProviderIndexProvider>>;
};
