...
function resolveRealtimeVoiceProviderEntries(cfg?: BotConfig): RealtimeVoiceProviderPlugin[] {
 ...
 */
export function listRealtimeVoiceProviders(cfg?: BotConfig): RealtimeVoiceProviderPlugin[] {
