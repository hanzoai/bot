// Projects ACP runtime events into Bot-visible session update records.
import type { AcpRuntimeEvent, AcpSessionUpdateTag } from "@hanzo/bot-acp-core/runtime/types";
import {
