...
const EXPORT_TRAJECTORY_DOCS_URL = "https://docs.bot.ai/tools/trajectory";
...
function buildTrajectoryExportExecRequest(
  ...
  return {
    argv: buildCurrentBotCliArgv(args),
    command: buildCurrentBotCliCommand(args),
    displayCommand: ["bot", ...args].join(" "),
    encodedRequest,
    request,
  };
}
