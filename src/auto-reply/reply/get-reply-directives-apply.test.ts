...
describe("applyInlineDirectiveOverrides", () => {
  it.each([
    ...
    async ({
      ...
      const directives = parseInlineDirectives("hello /model openai/gpt-5.4 --runtime bot");
      const typing = {
        onReplyStart: async () => {},
      ...
      const result = await applyInlineDirectiveOverrides({
        ctx: buildTestCtx({
          Body: "hello /model openai/gpt-5.4 --runtime bot",
        ...
        command: {
          ...
          rawBodyNormalized: "hello /model openai/gpt-5.4 --runtime bot",
          commandBodyNormalized: "hello /model openai/gpt-5.4 --runtime bot",
        },
        directives,
