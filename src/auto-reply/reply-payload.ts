...
const PAIRING_QR_REPLY_CHANNEL_DATA_KEY = "botPairingQr";
...
export function isFastModeAutoProgressPayload(payload: Pick<ReplyPayload, "channelData">): boolean {
  return payload.channelData?.botProgressKind === FAST_MODE_AUTO_PROGRESS_KIND;
}
...
export type ReplyPayloadMetadata = {
  ...
  /**
   * Internal Bot notices and host-owned artifacts are not assistant source
