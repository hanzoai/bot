...
export function isCommandEnabled(cfg: BotConfig, commandKey: string): boolean {
...
export function getCommandDetection(_cfg?: BotConfig): CommandDetection {
  const commands = getChatCommands();
...
export function maybeResolveTextAlias(raw: string, cfg?: BotConfig) {
