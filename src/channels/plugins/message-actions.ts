...
export function listChannelMessageActions(cfg: BotConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: BotConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: BotConfig): boolean {
  for (const plugin of listChannelPlugins()) {
