...
const sandboxRootTracker = createSuiteTempRootTracker({ prefix: "bot-docker-setup-" });
...
export function isGatewayStartLine(line: string) {
  return line.includes("compose") && line.includes(" up -d") && line.includes("bot-gateway");
}
