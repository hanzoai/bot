...
import { normalizeUniqueStringEntriesLower } from "@hanzo/bot-normalization-core/string-normalization";
...
/** Resolves enabled diagnostic flags from config plus `BOT_DIAGNOSTICS` overrides. */
