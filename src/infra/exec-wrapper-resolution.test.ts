...
describe("unwrapKnownDispatchWrapperInvocation", () => {
  test.each([
    ...
    {
      argv: ["flock", "-n", "/tmp/bot.lock", "bash", "-lc", "echo hi"],
      expected: { kind: "unwrapped", wrapper: "flock", argv: ["bash", "-lc", "echo hi"] },
    },
    {
      argv: ["flock", "-en", "/tmp/bot.lock", "bash", "-lc", "echo hi"],
      expected: { kind: "unwrapped", wrapper: "flock", argv: ["bash", "-lc", "echo hi"] },
    },
    {
      argv: ["flock", "-E", "1", "/tmp/bot.lock", "bash", "-lc", "echo hi"],
      expected: { kind: "unwrapped", wrapper: "flock", argv: ["bash", "-lc", "echo hi"] },
    },
    {
      argv: ["flock", "-F", "/tmp/bot.lock", "bash", "-lc", "echo hi"],
      expected: { kind: "unwrapped", wrapper: "flock", argv: ["bash", "-lc", "echo hi"] },
    },
    {
      argv: ["flock", "-o", "/tmp/bot.lock", "bash", "-lc", "echo hi"],
      expected: { kind: "unwrapped", wrapper: "flock", argv: ["bash", "-lc", "echo hi"] },
    },
    {
      argv: ["flock", "--nb", "/tmp/bot.lock", "bash", "-lc", "echo hi"],
      expected: { kind: "unwrapped", wrapper: "flock", argv: ["bash", "-lc", "echo hi"] },
    },
    {
      argv: ["flock", "--wait", "1", "/tmp/bot.lock", "bash", "-lc", "echo hi"],
      expected: { kind: "unwrapped", wrapper: "flock", argv: ["bash", "-lc", "echo hi"] },
    },
    {
    ...
    {
      argv: ["flock", "/tmp/bot.lock", "-c", "echo hi"],
      expected: { kind: "blocked", wrapper: "flock" },
    },
    {
      argv: ["flock", "-un", "/tmp/bot.lock", "bash", "-lc", "echo hi"],
      expected: { kind: "blocked", wrapper: "flock" },
    },
    {
      argv: ["flock", "-u", "9"],
...
describe("resolveDispatchWrapperTrustPlan", () => {
  ...
  test.each([
    ...
    {
      argv: ["flock", "--timeout=2", "/tmp/bot.lock", "bash", "-lc", "echo hi"],
      wrapper: "flock",
      effectiveArgv: ["bash", "-lc", "echo hi"],
    },
    {
      argv: ["flock", "--close", "/tmp/bot.lock", "bash", "-lc", "echo hi"],
      wrapper: "flock",
      effectiveArgv: ["bash", "-lc", "echo hi"],
    },
    {
      argv: ["flock", "--no-fork", "/tmp/bot.lock", "bash", "-lc", "echo hi"],
      wrapper: "flock",
      effectiveArgv: ["bash", "-lc", "echo hi"],
    },
    {
