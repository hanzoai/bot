...
const BLOCKED_WORKSPACE_DOTENV_KEYS = new Set([
  ...
  "BOT_LIVE_GEMINI_KEY",
  "BOT_LIVE_OPENAI_KEY",
  "BOT_MPM_CATALOG_PATHS",
  "BOT_NODE_EXEC_FALLBACK",
  "BOT_NODE_EXEC_HOST",
  "BOT_OAUTH_DIR",
  "BOT_PINNED_PYTHON",
  "BOT_PINNED_WRITE_PYTHON",
  "BOT_PLUGIN_INSTALL_OVERRIDES",
  "BOT_PLUGIN_CATALOG_PATHS",
  "BOT_PROFILE",
  "BOT_RAW_STREAM",
  "BOT_RAW_STREAM_PATH",
  "BOT_SHOW_SECRETS",
...
const BLOCKED_WORKSPACE_DOTENV_PREFIXES = [
  ...
  "AWS_ENDPOINT_URL_",
  "OPENAI_API_KEY_",
  // Workspace .env is untrusted; reserve the full Bot runtime namespace
  // for shell/global config so new BOT_* controls are fail-closed by default.
  "BOT_",
  "BOT_CLAWHUB_",
  "BOT_DISABLE_",
  "BOT_SKIP_",
