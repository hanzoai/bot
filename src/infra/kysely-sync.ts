...
const statementCacheSymbol = Symbol("bot.kyselySyncStatementCache");
const statementInvalidationSymbol = Symbol("bot.kyselySyncStatementInvalidation");
const statementCacheEnabledSymbol = Symbol("bot.kyselySyncStatementCacheEnabled");
const authorizerActiveSymbol = Symbol("bot.kyselySyncAuthorizerActive");
