...
import { formatErrorMessage as formatSharedErrorMessage } from "@hanzo/bot-normalization-core/error-coercion";
...
export { stringifyNonErrorCause, toErrorObject } from "@hanzo/bot-normalization-core/error-coercion";
