...
const LAUNCHER_ENCODING_MARKER_PREFIX = "@rem bot-launcher-encoding=";
const LAUNCHER_ENCODING_MARKER_RE = /^@rem bot-launcher-encoding=(\S+)\s*$/;
...
/** Decodes launcher scripts written by any Bot version (UTF-16 LE BOM, marked code page, or UTF-8). */
