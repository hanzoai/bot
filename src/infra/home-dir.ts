// Resolves Bot home and platform-specific config directories.
...
/** Resolves Bot's effective home, honoring BOT_HOME before OS homes. */
...
/** Resolves the underlying OS user home, ignoring BOT_HOME overrides. */
...
export function resolveRequiredHomeDir(
  ...
  throw new Error(
    "Unable to resolve an Bot home: set BOT_HOME, HOME, or USERPROFILE, or run from an existing directory.",
  );
}
...
/** Resolves a user-supplied path against the OS home, ignoring BOT_HOME. */
