...
// Bot HTTP/1, timeout, proxy TLS, and IP-safe proxy policies.
import {
...
/** Creates a direct undici Agent with Bot's HTTP/1-only dispatcher policy. */
...
/**
 * Creates an EnvHttpProxyAgent with Bot proxy TLS, IP-safe proxy pools,
