...
// adding Bot NO_PROXY CIDR/wildcard bypass checks.
 ...
 * - Bot extension: IPv4 CIDR and octet-wildcard entries
 ...
 * in provider HTTP helpers; see bot#64974 review thread on NO_PROXY
 * SSRF bypass.
 */
