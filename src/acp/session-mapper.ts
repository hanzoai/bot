/** Resolves ACP request metadata into Bot Gateway session keys and reset behavior. */
import { readBool, readString } from "@hanzo/bot-acp-core/meta";
...
/** Parses ACP request metadata into Bot session routing hints. */
