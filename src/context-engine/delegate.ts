...
import { normalizeStructuredPromptSection } from "@hanzo/bot-ai/internal/shared";
...
/**
 * Delegate a context-engine compaction request to Bot's built-in runtime compaction path.
 *
