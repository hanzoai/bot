// Bot-owned tool runtime contract helpers mock agent tool runtimes in SDK tests.
...
export function installBotOwnedToolHooks(params?: {
 ...
 * Pair with `installBotOwnedToolHooks()` when a test asserts before/after hook behavior.
 */
...
export function resetBotOwnedToolHooks(): void {
  resetGlobalHookRunner();
  resetPluginRuntimeStateForTest();
