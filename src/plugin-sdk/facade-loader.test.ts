...
const FACADE_LOADER_GLOBAL = "__botTestLoadBundledPluginPublicSurfaceModuleSync";
...
describe("plugin-sdk facade loader", () => {
  it("honors trusted bundled plugin dir overrides under the package root", () => {
    const pluginId = nextTrustedPluginId("bot-facade-loader-override-");
    const overrideA = createBundledPluginFixture({
      pluginId,
      kind: "dist",
      prefix: "bot-facade-loader-a-",
      marker: "override-a",
    });
    const overrideB = createBundledPluginFixture({
      pluginId,
      kind: "dist-runtime",
      prefix: "bot-facade-loader-b-",
      marker: "override-b",
    });

    process.env.BOT_BUNDLED_PLUGINS_DIR = overrideA.bundledPluginsDir;
    ...
    process.env.BOT_BUNDLED_PLUGINS_DIR = overrideB.bundledPluginsDir;
  ...
  it("falls back to package source surfaces when an override dir lacks a bundled plugin", () => {
    const fixture = createPackageSourcePluginFixture({
      prefix: "bot-facade-loader-source-fallback-",
      marker: "source-fallback",
    });
    process.env.BOT_BUNDLED_PLUGINS_DIR = createTempDirSync("bot-facade-loader-empty-");
  ...
  it("shares loaded facade ids with facade-runtime", () => {
    const fixture = createBundledPluginFixture({
      prefix: "bot-facade-loader-ids-",
      marker: "identity-check",
    });
    process.env.BOT_BUNDLED_PLUGINS_DIR = fixture.bundledPluginsDir;
  ...
  it("uses native require for Windows dist facade loads", () => {
    const fixture = createBundledPluginFixture({
      prefix: "bot-facade-loader-windows-",
  ...
  it("breaks circular facade re-entry during module evaluation", () => {
    const fixture = createCircularPluginFixture("bot-facade-loader-circular-");
    process.env.BOT_BUNDLED_PLUGINS_DIR = fixture.bundledPluginsDir;
  ...
  it("clears the cache on load failure so retries re-execute", () => {
    const fixture = createThrowingPluginFixture("bot-facade-loader-throw-");
    process.env.BOT_BUNDLED_PLUGINS_DIR = fixture.bundledPluginsDir;
