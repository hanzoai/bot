// Browser control auth helpers resolve plugin browser credentials from Bot config.
...
type BrowserControlAuthSurface = {
  resolveBrowserControlAuth: (cfg?: BotConfig, env?: NodeJS.ProcessEnv) => BrowserControlAuth;
