...
/** Runtime adapter that lets the package agent-core use Bot LLM helpers. */
export const botAgentCoreRuntime = {
...
/** Agent-core class preconfigured with Bot runtime dependencies. */
export class Agent extends CoreAgent {
  constructor(options: CoreAgentOptions = {}) {
    super({ runtime: botAgentCoreRuntime, ...options });
  }
}

// Bot-owned reusable agent core
