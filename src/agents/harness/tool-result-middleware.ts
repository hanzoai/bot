...
type MiddlewareContentBlock = BotAgentToolResult["content"][number];
...
function isValidMiddlewareToolResult(value: unknown): value is BotAgentToolResult {
...
function coerceMiddlewareToolResult(
  ...
  const content: BotAgentToolResult["content"] = [];
 ...
 */
function sanitizeToolResultForMiddleware(result: BotAgentToolResult): BotAgentToolResult {
...
function buildMiddlewareFailureResult(): BotAgentToolResult {
  return {
    content: [
      {
        type: "text",
...
function reconcileDeliveredMessagingFailure(
  result: BotAgentToolResult,
  fallback: BotAgentToolResult | undefined,
): BotAgentToolResult {
