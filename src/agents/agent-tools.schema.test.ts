import { normalizeToolParameterSchema } from "@hanzo/bot-ai/internal/openai";
 ...
 */
import { runAgentLoop, type AgentEvent, type StreamFn } from "bot/plugin-sdk/agent-core";
import { createAssistantMessageEventStream, validateToolArguments } from "bot/plugin-sdk/llm";
