...
import {
  resolveBotPluginToolInputs,
  type BotPluginToolOptions,
} from "./bot-tools.plugin-context.js";
import { applyPluginToolDeliveryDefaults } from "./plugin-tool-delivery-defaults.js";
import { resolveAgentRuntimeToolConfig } from "./tool-runtime-config.js";
import type { AnyAgentTool } from "./tools/common.js";

type ResolveBotPluginToolsOptions = BotPluginToolOptions & {
...
export function resolveBotPluginToolsForOptions(params: {
  options?: ResolveBotPluginToolsOptions;
  ...
  const resolveApiKeyForProvider = authProfileStore
    ...
    : undefined;
  const pluginToolInputs = resolveBotPluginToolInputs({
