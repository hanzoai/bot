...
function getPackageDir(): string {
  ...
  const envDir = process.env.BOT_PACKAGE_DIR;
  if (envDir) {
    if (envDir === "~") {
      return homedir();
    }
...
// =============================================================================
// App Config (from package.json botConfig)
// =============================================================================
...
const botConfigName: string | undefined = pkg.botConfig?.name;
export const APP_NAME: string = botConfigName || "bot";
export const CONFIG_DIR_NAME: string = pkg.botConfig?.configDir || ".bot";
...
// =============================================================================
// User Config Paths (~/.bot/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.bot/agent/) */
