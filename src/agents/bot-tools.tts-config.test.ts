// Verifies createBotTools wires shared config and context into the TTS tool.
...
const mocks = vi.hoisted(() => {
  ...
  return {
    ...
    textToSpeech: vi.fn(async () => ({
      success: true,
      audioPath: "/tmp/bot/tts-config-test.opus",
      provider: "microsoft",
...
vi.mock("./bot-tools.nodes-workspace-guard.js", () => ({
...
describe("createBotTools TTS config wiring", () => {
  beforeEach(() => {
...
describe("createBotTools media generation session wiring", () => {
  beforeEach(() => {
    mocks.createImageGenerateToolOptions.mockClear();
    mocks.createMusicGenerateToolOptions.mockClear();
    mocks.createVideoGenerateToolOptions.mockClear();
...
describe("createBotTools session status route context wiring", () => {
  beforeEach(() => {
...
describe("createBotTools cron context wiring", () => {
  beforeEach(() => {
    mocks.createCronToolOptions.mockClear();
  });
