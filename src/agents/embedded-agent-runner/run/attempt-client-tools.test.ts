...
const CODE_MODE_CONFIG: BotConfig = { tools: { codeMode: true, toolSearch: false } };
const TOOL_SEARCH_CONFIG: BotConfig = {
  tools: { codeMode: false, toolSearch: { enabled: true, mode: "tools" } },
};
const CATALOGS_DISABLED_CONFIG: BotConfig = {
 ...
 */
function seedCatalog(mode: "code-mode" | "tool-search", config: BotConfig) {
...
function prepare(input: {
  ...
  attemptConfig: BotConfig;
  toolSearchRuntimeConfig: BotConfig;
