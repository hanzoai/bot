...
type PromptReleaseStreamFn = ((...args: unknown[]) => Promise<unknown>) & {
  botSessionLockPromptReleaseInstalled?: true;
};
...
export function installPromptSubmissionLockRelease(params: {
  ...
  if (currentStreamFn.botSessionLockPromptReleaseInstalled === true) {
    return;
  }
  ...
  wrappedStreamFn.botSessionLockPromptReleaseInstalled = true;
