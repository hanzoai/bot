...
const SESSION_KEY_WRITE_LEASE_STATE_KEY = Symbol.for("bot.sessionWriteLeaseState");
...
function resolveSessionKeyLeaseDatabaseOptions(sessionKey: string): BotAgentDatabaseOptions {
...
function runSessionKeyLeaseWrite<T>(
  databaseOptions: BotAgentDatabaseOptions,
  operation: (params: {
    db: ReturnType<typeof openBotAgentDatabase>["db"];
...
const SESSION_LOCK_SWEEPS = createFileLockManager("bot.session-write-lock-sweep");
