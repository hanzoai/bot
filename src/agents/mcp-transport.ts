 ...
 * streamable-HTTP SDK transports with Bot auth, redirect, and logging rules.
 */
import {
  SSEClientTransport,
...
function attachStderrLogging(serverName: string, transport: BotStdioClientTransport) {
...
export function resolveMcpTransport(
  serverName: string,
  rawServer: unknown,
  options?: { cfg?: BotConfig; agentDir?: string },
