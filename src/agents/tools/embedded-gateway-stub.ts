 ...
 */
import { normalizeFastMode, type FastMode } from "@hanzo/bot-normalization-core/string-coerce";
import type {
  SessionsListParams,
...
interface EmbeddedGatewayRuntime {
  ...
  resolveDefaultAgentId: (config: BotConfig) => string;
  resolveSessionStoreKey: (params: { cfg: BotConfig; sessionKey: string }) => string;
  ...
  resolveEffectiveChatHistoryMaxChars: (cfg: BotConfig) => number;
