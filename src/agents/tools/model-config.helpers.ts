...
/** Resolves the configured default model ref, falling back to Bot defaults. */
export function resolveDefaultModelRef(cfg?: BotConfig): { provider: string; model: string } {
  if (cfg) {
...
if (process.env.VITEST || process.env.NODE_ENV === "test") {
  (globalThis as Record<PropertyKey, unknown>)[Symbol.for("bot.modelConfigHelpersTestApi")] = {
