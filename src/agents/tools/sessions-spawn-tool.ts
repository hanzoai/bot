...
// Keep the schema local to avoid a circular import through acp-spawn/bot-tools.
...
function resolveAcpUnavailableMessage(opts?: { sandboxed?: boolean; config?: BotConfig }) {
