    ...
    lines.push(
      ...
      ...(acpEnabled
        ? [
            ...
            "`agents_list`/`subagents` = Bot runtime=subagent only; ACP ids from `acp.allowedAgents`.",
            "Never ask user for slash/CLI or exec bot/acpx when sessions_spawn can act.",
