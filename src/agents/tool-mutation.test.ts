...
describe("tool mutation helpers", () => {
  ...
  it.each([
    ...
    ["exec", "gh search prs --repo hanzoai/bot tool-mutation --json number,title,state"],
    ["bash", "gh pr view 123 --repo hanzoai/bot --json title,state"],
  ...
  it.each([
    ...
    ["exec", "gh api --method POST repos/hanzoai/bot/issues"],
