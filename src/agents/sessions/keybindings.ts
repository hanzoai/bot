 ...
 *
 * Wraps pi-tui keybindings with Bot-specific actions and per-agent overrides.
 */
...
/** Bot-specific key ids added to the shared pi-tui keybinding registry. */
...
/** Keybinding manager that loads Bot defaults plus optional user overrides. */
