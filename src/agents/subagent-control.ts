...
export async function killSubagentRunAdmin(params: { cfg: BotConfig; sessionKey: string }) {
...
if (process.env.VITEST || process.env.NODE_ENV === "test") {
  (globalThis as Record<PropertyKey, unknown>)[Symbol.for("bot.subagentControlTestApi")] =
    testing;
}
