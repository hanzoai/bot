...
describe("isShellLikeCodeModeSource", () => {
  ...
  it.each([
    ...
    'const result = await tools.callValue("bot:core:exec", { command: "ls" }); return result;',
    'return await tools.callValue("bot:core:read", { path: "/workspace" });',
    "console.log(await tools.callValue('bot:core:read', { path: '/workspace' }));",
