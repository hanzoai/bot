// Covers conversion from Bot bundle-MCP config into Codex app-server
...
describe("buildCodexMcpServersConfig", () => {
  it("normalizes Bot MCP servers into Codex app-server mcp_servers shape", () => {
    ...
    expect(
      ...
      bot: {
        ...
        bearer_token_env_var: "BOT_MCP_TOKEN",
        http_headers: {
          "x-static": "static-value",
        },
        env_http_headers: {
