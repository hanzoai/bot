...
/**
 * Runtime context resolver for Bot plugin tools.
 *
...
/** Options provided by agent runtime callers when invoking Bot plugin tools. */
...
export function resolveBotPluginToolInputs(params: {
  options?: BotPluginToolOptions;
