...
const AGENT_CLEANUP_STEP_TIMEOUT_ENV = "BOT_AGENT_CLEANUP_TIMEOUT_MS";
const TRAJECTORY_FLUSH_TIMEOUT_ENV = "BOT_TRAJECTORY_FLUSH_TIMEOUT_MS";
...
function resolveAgentCleanupStepTimeoutMs(params: {
  ...
  if (params.step === "bot-trajectory-flush") {
