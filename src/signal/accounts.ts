...
export function listSignalAccountIds(cfg: BotConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: BotConfig): string {
...
function resolveAccountConfig(cfg: BotConfig, accountId: string): SignalAccountConfig | undefined {
  const accounts = cfg.channels?.signal?.accounts;
  if (!accounts || typeof accounts !== "object") {
    return undefined;
  }
...
function mergeSignalAccountConfig(cfg: BotConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: BotConfig): ResolvedSignalAccount[] {
