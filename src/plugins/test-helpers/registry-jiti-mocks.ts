...
vi.mock("../discovery.js", () => ({
  discoverBotPlugins: (
    ...args: Parameters<typeof registryJitiMocks.discoverBotPlugins>
  ) => registryJitiMocks.discoverBotPlugins(...args),
}));
