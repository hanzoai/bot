/** Tests bundle manifest parsing for Codex, Claude, Cursor, and Bot formats. */
...
function makeTempDir() {
  return makeTrackedTempDir("bot-bundle-manifest", tempDirs);
}
...
describe("bundle manifest parsing", () => {
  it("does not treat bot.bundle.json as a bundle manifest", () => {
    const rootDir = makeTempDir();
    writeBundleManifest(rootDir, "bot.bundle.json", {
      name: "Not Real",
      skills: ["skills"],
    });
