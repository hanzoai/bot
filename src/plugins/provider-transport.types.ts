...
/**
 * Provider-owned stream wrapper hook after Bot applies its generic
 ...
 *
 * Return `true` or `false` to override Bot's built-in provider cache TTL
 ...
 *
 * Runs only after Bot exhausts normal env/profile/config auth resolution
 ...
 * hint suffix that Bot should append to the generic `Unknown model`
 * error.
 */
