 ...
 *
 * Runs after Bot resolves an explicit/discovered/dynamic model and before
 ...
 *
 * The helper methods cover the common Bot auth resolution paths:
 *
 ...
 *
 * Called when OAuth refresh fails and Bot wants a provider-specific repair
...
/**
 * Provider-owned extra-param normalization before Bot builds its generic
 ...
 */
/** Provider-facing effort after Bot lowers orchestration-only modes. */
