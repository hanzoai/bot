...
import type { BotPackageBuild, PluginPackageChannel } from "./manifest.js";
...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by Bot from plugin manifests, install records, and config policy. Use `bot plugins registry --refresh`, `bot plugins install/update/uninstall`, or `bot plugins enable/disable` instead.";
...
export type InstalledPluginIndexRecord = {
  ...
  /**
   * Package-authored bot.install metadata. This describes catalog/package
