...
export const normalizePluginsConfig = (config?: BotConfig["plugins"]): NormalizedPluginsConfig => {
...
const hasExplicitMemorySlot = (plugins?: BotConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: BotConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: BotConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }
