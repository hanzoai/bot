...
type RuntimeConfigMutationContext = {
  snapshot: import("../../config/types.bot.js").ConfigFileSnapshot;
...
type RuntimeMutateConfigFileParams<T = void> = {
  ...
  mutate: (
    draft: import("../../config/types.bot.js").BotConfig,
...
export type PluginRuntimeCore = {
  ...
  config: {
    ...
    current: () => DeepReadonly<import("../../config/types.bot.js").BotConfig>;
    /**
  ...
  media: {
    ...
    detectMime: typeof import("@hanzo/bot-media-core/mime").detectMime;
    mediaKindFromMime: typeof import("@hanzo/bot-media-core/constants").mediaKindFromMime;
  ...
  modelAuth: {
    ...
    getApiKeyForModel: (params: {
      model: import("bot/plugin-sdk/llm").Model<import("bot/plugin-sdk/llm").Api>;
      cfg?: import("../../config/types.bot.js").BotConfig;
      workspaceDir?: string;
