...
const residue = {
  legacyProfileDir: "/tmp/bot-home/browser/clawd",
  legacyUserDataDir: "/tmp/bot-home/browser/clawd/user-data",
  canonicalUserDataDir: "/tmp/bot-home/browser/bot/user-data",
};
...
describe("browser clawd profile residue health check", () => {
  ...
  it("reports legacy clawd profile residue through doctor lint", async () => {
    ...
    const cfg: BotConfig = { browser: { profiles: { bot: { color: "#FF4500" } } } };
