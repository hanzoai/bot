...
function resolveTranscriptsSourceProviderEntries(cfg?: BotConfig): TranscriptSourceProvider[] {
...
export function listTranscriptSourceProviders(cfg?: BotConfig): TranscriptSourceProvider[] {
