...
export async function handleToolsInvokeHttpRequest(
  ...
  const accountId = normalizeOptionalString(getHeader(req, "x-bot-account-id"));
  const agentTo = normalizeOptionalString(getHeader(req, "x-bot-message-to"));
  const agentThreadId = normalizeOptionalString(getHeader(req, "x-bot-thread-id"));
