// Bot Gateway client facade.
// Injects Bot host dependencies into the shared gateway-client package.
...
function createBotGatewayClientHostDeps(
  overrides?: GatewayClientHostDeps,
): GatewayClientHostDeps {
  return {
    // This wrapper is the only place the package reaches into Bot runtime
...
export class GatewayClient {
  ...
  constructor(opts: GatewayClientOptions) {
    this.#client = new BaseGatewayClient({
      ...
      hostDeps: createBotGatewayClientHostDeps(opts.hostDeps),
    });
  }
