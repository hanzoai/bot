...
// Deduplicates external history messages against local Bot transcripts.
...
function resolveImportedExternalIdentity(message: unknown): ImportedExternalIdentity | undefined {
  ...
  const meta =
    "__bot" in message &&
    (message as { __bot?: unknown })["__bot"] &&
    typeof (message as { __bot?: unknown })["__bot"] === "object"
      ? ((message as { __bot?: Record<string, unknown> })["__bot"] ?? {})
      : undefined;
