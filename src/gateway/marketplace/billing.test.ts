...
describe("calculateMarketplacePrice", () => {
  it("calculates pricing for a known model (sonnet 4)", () => {
    ...
    // Input: 1M * $3 = 300 cents, Output: 100K * $15 = 150 cents
    // List: 450, Buyer 60%: 270, Platform 20%: 54, Seller: 216
  ...
  it("calculates pricing for opus (expensive model)", () => {
    ...
    // Opus: $15/$75 per MTok
    // Input: 0.5M * $15 = 750c, Output: 0.05M * $75 = 375c
    // List: 1125, Buyer 60%: 675, Platform 20%: 135, Seller: 540
  ...
  it("respects custom priceFraction", () => {
    const customConfig: MarketplaceConfig = { ...defaultConfig, priceFraction: 0.8 };
