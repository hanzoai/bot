...
import { clearActivatedPluginRuntimeState, loadBotPlugins } from "../plugins/loader.js";
...
const PLUGIN_SUBAGENT_POLICY_STATE_KEY: unique symbol = Symbol.for(
  "bot.pluginSubagentOverridePolicyState",
);
...
export function setPluginSubagentOverridePolicies(cfg: BotConfig): void {
  ...
  if (!policy?.allowModelOverride) {
    return {
      ...
      reason:
        ...
        "See https://docs.bot.ai/plugins/sdk-runtime#api-runtime-subagent and search for: " +
