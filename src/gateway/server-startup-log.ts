...
import { normalizeSortedUniqueStringEntries } from "@hanzo/bot-normalization-core/string-normalization";
...
function formatConfiguredChannelMissingOwnerStartupWarning(entry: {
  ...
  return (
    ...
    `is installed or loadable (${reasons}). Run \`bot doctor --fix\` or install the ` +
