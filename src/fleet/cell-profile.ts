...
export const DEFAULT_FLEET_IMAGE = "ghcr.io/hanzoai/bot:latest";
...
export const FLEET_TENANT_LABEL = "bot.fleet.tenant";
export const FLEET_OWNER_LABEL = "bot.fleet.owner";
export const FLEET_ATTEMPT_LABEL = "bot.fleet.attempt";
export const FLEET_ENV_KEYS_LABEL = "bot.fleet.env-keys";
export const FLEET_DISK_LIMIT_LABEL = "bot.fleet.disk-limit";
...
export function cellContainerName(tenantId: string): string {
  return `bot-cell-${validateTenantId(tenantId)}`;
}
