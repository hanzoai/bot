...
describe("status-all format", () => {
  ...
  it("formats dashboard values consistently", () => {
    expect(formatStatusDashboardValue("https://bot.local")).toBe("https://bot.local");
  ...
  it("builds overview rows with shared ordering", () => {
    expect(
      buildStatusOverviewRows({
        ...
        dashboardValue: "https://bot.local",
        ...
        middleRows: [{ Item: "Security", Value: "Run: bot security audit --deep" }],
      ...
      { Item: "Dashboard", Value: "https://bot.local" },
      ...
      { Item: "Security", Value: "Run: bot security audit --deep" },
