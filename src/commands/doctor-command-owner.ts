...
function resolveConfiguredCommandOwners(cfg: BotConfig): string[] {
...
export function hasConfiguredCommandOwners(cfg: BotConfig): boolean {
...
export function noteCommandOwnerHealth(cfg: BotConfig): void {
  ...
  note(
    [
      ...
      `Fix: set commands.ownerAllowFrom to your channel user id, for example ${formatCliCommand("bot config set commands.ownerAllowFrom '[\"telegram:123456789\"]'")}`,
