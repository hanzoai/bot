// Fast `bot status --json` scan policy.
...
type StatusJsonScanPolicy = {
  ...
  gatewayProbeTimeoutMs?: number | ((cfg: BotConfig) => number | undefined);
...
function hasExplicitStatusJsonChannelConfig(cfg: BotConfig): boolean {
...
function hasPotentialConfiguredChannelsForStatusJson(cfg: BotConfig): boolean {
