...
async function restartRunningGatewayServiceAfterUpdate(
  ...
  try {
    ...
    note("Restarted the running gateway service after updating Bot.", "Update");
    return true;
  } catch (err) {
...
/** Offers to update Bot before doctor when running interactively from an updatable install. */
