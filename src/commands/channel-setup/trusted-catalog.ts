...
function resolveEffectiveTrustConfig(cfg: BotConfig, env?: NodeJS.ProcessEnv): BotConfig {
...
function resolveTrustedCatalogExtraPaths(cfg: BotConfig): string[] | undefined {
