...
type BrowserDoctorSurface = {
  noteChromeMcpBrowserReadiness: (cfg: BotConfig, deps?: BrowserDoctorDeps) => Promise<void>;
...
export async function noteChromeMcpBrowserReadiness(cfg: BotConfig, deps?: BrowserDoctorDeps) {
  try {
