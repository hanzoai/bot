...
function collectToolAllowlistSources(cfg: BotConfig): ToolAllowlistSource[] {
...
function collectConfiguredMcpServerNames(cfg: BotConfig): string[] {
...
function collectSandboxMcpAllowlistWarnings(cfg: BotConfig): string[] {
