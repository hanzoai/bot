// Doctor contribution for low disk space around the Bot state directory.
import os from "node:os";
import { expectDefined, formatByteSize } from "@hanzo/bot-normalization-core";
 ...
 *
 * This catches a common operational failure mode where Bot silently
