...
function listConfiguredChannelIds(cfg: BotConfig): string[] {
...
function listConfiguredChannelAccountIds(cfg: BotConfig, channelId: string): string[] {
  if (!hasRecord(cfg.channels)) {
    return [];
  }
...
export function collectChannelRouteTargets(cfg: BotConfig): ChannelRouteTarget[] {
