...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "secrets.kms.siteUrl": "KMS Site URL",
  "secrets.kms.orgSlug": "KMS Org Slug",
  "secrets.kms.projectId": "KMS Project ID",
  "secrets.kms.projectSlug": "KMS Project Slug",
  "secrets.kms.environment": "KMS Environment",
  "secrets.kms.secretPath": "KMS Secret Path",
  "secrets.kms.accessToken": "KMS Access Token",
  "secrets.kms.machineIdentity.clientId": "KMS Machine Identity Client ID",
  "secrets.kms.machineIdentity.clientSecret": "KMS Machine Identity Client Secret",
  "secrets.kms.cacheTtlMs": "KMS Secret Cache TTL (ms)",
  "secrets.kms.requestTimeoutMs": "KMS Request Timeout (ms)",
...
export const FIELD_HELP: Record<string, string> = {
  ...
  "secrets.backend":
    'Secret resolution mode ("local" keeps current behavior; "kms" enables KMS-backed secret references).',
  "secrets.kms.siteUrl": "KMS base URL (default: https://kms.hanzo.ai).",
  "secrets.kms.orgSlug": "Optional org slug metadata for tenant scoping and audit context.",
  "secrets.kms.projectId": "Project/workspace id used for secret lookups.",
  "secrets.kms.projectSlug": "Project/workspace slug used for secret lookups.",
  "secrets.kms.environment":
    "Environment slug used for secret lookups (for example: dev/staging/prod).",
  "secrets.kms.secretPath": "Default folder path for KMS lookups (default: /).",
  "secrets.kms.accessToken":
    "Optional static KMS access token. Prefer machine identity credentials where possible.",
  "secrets.kms.machineIdentity.clientId": "KMS machine identity client id.",
  "secrets.kms.machineIdentity.clientSecret": "KMS machine identity client secret.",
  "secrets.kms.cacheTtlMs": "Resolved secret cache TTL in milliseconds.",
  "secrets.kms.requestTimeoutMs": "HTTP timeout for KMS API requests in milliseconds.",
  ...
  "agents.defaults.memorySearch.store.path":
    "SQLite index path (default: ~/.hanzo/bot/memory/{agentId}.sqlite).",
  ...
  "memory.backend": 'Memory backend ("builtin" for Hanzo Bot embeddings, "qmd" for QMD sidecar).',
