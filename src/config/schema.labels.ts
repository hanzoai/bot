...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.alsoAllow": "Tool Also Allow",
  "tools.byProvider": "Tool by Provider",
  "tools.exec.approvalRunningNoticeMs": "Exec Approval Running Notice (ms)",
  "tools.links.enabled": "Link Understanding Enabled",
  "tools.links.maxLinks": "Link Understanding Max Links",
  "tools.links.models": "Link Understanding Models",
  "tools.links.scope": "Link Understanding Scope",
  "tools.links.timeoutSeconds": "Link Understanding Timeout (sec)",
  "tools.media.audio.attachments": "Audio Attachment Policy",
  "tools.media.audio.enabled": "Audio Understanding Enabled",
  "tools.media.audio.language": "Audio Language",
  "tools.media.audio.maxBytes": "Audio Max Bytes",
  "tools.media.audio.maxChars": "Audio Max Chars",
  "tools.media.audio.models": "Audio Models",
  "tools.media.audio.prompt": "Audio Prompt",
  "tools.media.audio.scope": "Audio Scope",
  "tools.media.audio.timeoutSeconds": "Audio Timeout (sec)",
  "tools.media.concurrency": "Media Concurrency",
  "tools.media.image.attachments": "Image Attachment Policy",
  "tools.media.image.enabled": "Image Understanding Enabled",
  "tools.media.image.maxBytes": "Image Max Bytes",
  "tools.media.image.maxChars": "Image Max Chars",
  "tools.media.image.models": "Image Models",
  "tools.media.image.prompt": "Image Prompt",
  "tools.media.image.scope": "Image Scope",
  "tools.media.image.timeoutSeconds": "Image Timeout (sec)",
  "tools.media.models": "Media Models",
  "tools.media.video.attachments": "Video Attachment Policy",
  "tools.media.video.enabled": "Video Understanding Enabled",
  "tools.media.video.maxBytes": "Video Max Bytes",
  "tools.media.video.maxChars": "Video Max Chars",
  "tools.media.video.models": "Video Models",
  "tools.media.video.prompt": "Video Prompt",
  "tools.media.video.scope": "Video Scope",
  "tools.media.video.timeoutSeconds": "Video Timeout (sec)",
  "tools.profile": "Tool Profile",

  // ── CHANNELS_AGENTS_TARGET_KEYS labels ────────────────────────────────
  "agents.defaults.memorySearch.chunking.overlap": "Memory Chunk Overlap",
  "agents.defaults.memorySearch.chunking.tokens": "Memory Chunk Tokens",
  "agents.defaults.memorySearch.enabled": "Memory Search Enabled",
  "agents.defaults.memorySearch.model": "Memory Search Model",
  "agents.defaults.memorySearch.query.maxResults": "Memory Search Max Results",
  "agents.defaults.memorySearch.query.minScore": "Memory Search Min Score",
  ...
  "agents.defaults.memorySearch.sync.watchDebounceMs": "Memory Watch Debounce (ms)",
  "agents.defaults.workspace": "Workspace",
  "agents.list[].tools.alsoAllow": "Agent Also Allow Tools",
  "agents.list[].tools.byProvider": "Agent Tool by Provider",
  "agents.list[].tools.profile": "Agent Tool Profile",
  "channels.bluebubbles": "BlueBubbles",
  "channels.irc": "IRC",
  ...
  "diagnostics.enabled": "Diagnostics Enabled",
  "diagnostics.otel.enabled": "OTEL Enabled",
  "diagnostics.otel.endpoint": "OTEL Endpoint",
  "diagnostics.otel.flushIntervalMs": "OTEL Flush Interval (ms)",
  "diagnostics.otel.headers": "OTEL Headers",
  "diagnostics.otel.logs": "OTEL Logs",
  "diagnostics.otel.metrics": "OTEL Metrics",
  "diagnostics.otel.sampleRate": "OTEL Sample Rate",
  "diagnostics.otel.serviceName": "OTEL Service Name",
  "diagnostics.otel.traces": "OTEL Traces",
  "gateway.remote.password": "Remote Gateway Password",
  "gateway.remote.token": "Remote Gateway Token",
  "skills.load.watch": "Watch Skills",
  "skills.load.watchDebounceMs": "Skills Watch Debounce (ms)",
