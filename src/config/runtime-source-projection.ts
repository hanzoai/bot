...
export function projectConfigOntoRuntimeSourceSnapshot(config: BotConfig): BotConfig {
  ...
  return applyMergePatch(projectedSource, runtimePatch) as BotConfig;
}
