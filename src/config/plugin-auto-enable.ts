...
function isTelegramConfigured(cfg: BotConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: BotConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: BotConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: BotConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: BotConfig): boolean {
...
function isIMessageConfigured(cfg: BotConfig): boolean {
...
function isWhatsAppConfigured(cfg: BotConfig): boolean {
...
function isGenericChannelConfigured(cfg: BotConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: BotConfig): string[] {
  const refs: string[] = [];
...
function ensureAllowlisted(cfg: BotConfig, pluginId: string): BotConfig {
...
function registerPluginEntry(cfg: BotConfig, pluginId: string): BotConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
