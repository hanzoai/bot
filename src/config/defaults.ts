...
export function applyTalkConfigNormalization(config: BotConfig): BotConfig {
...
export function applyCronDefaults(cfg: BotConfig): BotConfig {
  return cfg;
}
...
function hasAnthropicDefaultSignal(cfg: BotConfig, env: NodeJS.ProcessEnv): boolean {
