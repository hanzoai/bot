...
export function createConfigWriteAuditRecordBase(params: {
  ...
  return {
    ...
    watchMode: params.env.BOT_WATCH_MODE === "1",
    watchSession: normalizeAuditLabel(params.env.BOT_WATCH_SESSION),
    watchCommand: normalizeAuditLabel(params.env.BOT_WATCH_COMMAND),
...
export type ConfigAuditScrubResult = {
  ...
  // to swap the file. Caller should re-run `bot doctor --fix` once the
