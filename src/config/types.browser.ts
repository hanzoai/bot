...
export type BrowserProfileConfig = {
  ...
  mcpArgs?: string[];
  /**
   * Profile driver (default: bot). "extension" attaches to the user's
   * signed-in browser through the Bot Chrome extension relay.
   */
  driver?: "bot" | "clawd" | "existing-session" | "extension";
