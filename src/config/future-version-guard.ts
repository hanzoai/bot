...
export const ALLOW_OLDER_BINARY_DESTRUCTIVE_ACTIONS_ENV =
  "BOT_ALLOW_OLDER_BINARY_DESTRUCTIVE_ACTIONS";
...
export function resolveFutureConfigActionBlock(
  ...
  return {
    ...
    currentVersion,
    touchedVersion,
    message: `Refusing to ${params.action} because this Bot binary (${currentVersion}) is older than the config last written by Bot ${touchedVersion}.`,
    hints: [
