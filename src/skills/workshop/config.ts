// Workshop config helpers resolve skill workshop settings from Bot config.
...
export function resolveSkillWorkshopConfig(config?: BotConfig): SkillWorkshopConfig {
