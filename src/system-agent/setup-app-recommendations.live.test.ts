...
const LIVE = process.env.BOT_LIVE_TEST === "1" && Boolean(process.env.OPENAI_API_KEY?.trim());
const describeLive = LIVE ? describe : describe.skip;
const modelId = process.env.BOT_LIVE_APP_RECOMMENDATIONS_MODEL ?? "gpt-5.6-luna";
