...
const GENERATED_MEDIA_TASK_ACTIVITY_KEY = Symbol.for("bot.generatedMediaTaskActivity");
const GENERATED_MEDIA_TASK_ADMISSIONS_KEY = Symbol.for("bot.generatedMediaTaskAdmissions");
...
if (process.env.VITEST || process.env.NODE_ENV === "test") {
  (globalThis as Record<PropertyKey, unknown>)[
    Symbol.for("bot.generatedMediaTaskActivityTestApi")
