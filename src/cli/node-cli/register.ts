...
export function registerNodeCli(program: Command) {
    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          [
            "bot node run --host 127.0.0.1 --port 18789",
          ...
          ["bot node start", "Start the installed node host service."],
  ...
  node
    ...
    .option("--context-path <path>", "Gateway WebSocket context path (e.g. /bot-gw)")
