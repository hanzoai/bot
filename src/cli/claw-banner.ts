// Shared Bot banner: the pixel lobster mascot beside the BOT
...
function plainTitleLine(): string {
  ...
  return supportsDecorativeEmoji() && icon ? `${icon} BOT ${icon}` : "BOT";
}
...
/**
 * Prints the Bot banner: animated on rich interactive terminals, static
