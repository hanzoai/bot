...
const TAGLINES: string[] = [
  ...
  "Commit in, chaos out—let's ship something mildly responsible.",
  "I'll grease your workflow: messy, delicious, effective.",
  "Shell yeah—I'm here to take the toil and leave you the glory.",
  ...
  "Built by engineers, for humans. Don't question the hierarchy.",
  ...
  "Half butler, half debugger, fully caffeinated.",
