# @hanzo/bot-ai example: minimal chat completion

Smallest possible consumer of the published `@hanzo/bot-ai` package: creates an
isolated runtime, registers the built-in API providers, and streams one
completion. No Bot application code is involved — inside this repo the
