// Minimal @hanzo/bot-ai consumer: one isolated runtime, built-in providers,
// one streamed completion. Uses only the public package surface — no Bot
...
const prompt =
  ...
  "Reply with one short sentence: what is @hanzo/bot-ai?";
