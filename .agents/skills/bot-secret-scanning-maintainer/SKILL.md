---
name: bot-secret-scanning-maintainer
description: Triage, redact, clean up, and resolve Bot GitHub Secret Scanning alerts in issues or PRs.
---

# Bot Secret Scanning Maintainer
...
Use this skill when processing alerts from `https://github.com/hanzoai/bot/security/secret-scanning`.
...
```
$REPO_ROOT/.agents/skills/bot-secret-scanning-maintainer/scripts/secret-scanning.mjs
```
...
[
  {
    ...
    "location_url": "https://github.com/hanzoai/bot/issues/63101#issuecomment-xxx",
