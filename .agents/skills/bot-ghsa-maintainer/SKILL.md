---
name: bot-ghsa-maintainer
description: "Inspect, patch, validate, publish, or confirm Bot GHSA security advisories and private-fork state."
---

# Bot GHSA Maintainer

Use this skill for repo security advisory workflow only. Keep general release work in `release-bot-maintainer`.
