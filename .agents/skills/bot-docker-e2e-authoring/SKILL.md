---
name: bot-docker-e2e-authoring
description: "Author Bot Docker E2E and live provider Docker lanes."
---

# Bot Docker E2E Authoring
...
BOT_SKIP_DOCKER_BUILD=1 pnpm test:docker:<lane>
```
