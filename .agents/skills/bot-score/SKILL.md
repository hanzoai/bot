---
name: bot-score
description: Audit or refresh Bot maturity scorecard docs from root taxonomy, maturity scores, and QA evidence artifacts without using maintainer discrawl data or committed inventory reports.
---

# bot-score

Use this skill when working on the Bot maturity scorecard in this repo.
This is the bot-local version of the maintainer `bot-score` workflow:
...
`qa-evidence.json` artifact shape generated by Bot QA workflows.
...
2. Read the surface completeness rubric under
   `.agents/skills/bot-score/references/completeness/`.
...
By default, Completeness measures how fully Bot exposes the intended
...
tree to bot. Evidence-enriched scorecard outputs belong in short-lived
