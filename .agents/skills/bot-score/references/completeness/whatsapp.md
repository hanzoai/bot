...
- Channel Setup and Operations: Official @hanzo/bot-whatsapp plugin metadata, bot plugin install whatsapp, Channel config schema, Baileys socket lifecycle, Operator troubleshooting, Baileys socket lifecycle, Operator troubleshooting for reconnect loops
