---
name: bot-small-bugfix-sweep
description: Fix only small, high-certainty Bot bugs from a pasted issue/PR list after deep code review.
---

# Bot Small Bugfix Sweep

Batch workflow for pasted Bot issue/PR refs.
...
Use `$gitcrawl` first, `$bot-pr-maintainer` for live GitHub hygiene, `$github-deep-review` posture for source tracing, and `$bot-testing` for proof.
