...
- Applying repository-specific documentation overlays, including Bot page-type, docs IA, preservation, and validation rules when present.
...
6. For Bot docs work, read `references/bot.md` before the build/review playbook.
