...
- For Bot docs work, choose a page type from `references/bot.md` before drafting.
- Keep task-critical Bot configuration inline; link exhaustive defaults, enums, schemas, generated references, and rare debugging workflows.
...
- For Bot docs work, apply the validation checklist in `references/bot.md`.
