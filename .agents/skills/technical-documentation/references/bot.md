# Bot Documentation Overlay

Use this reference only for Bot docs work. It layers Bot-specific page
...
- Topic page: explain a major Bot entity or surface end to end.
...
- Governance file: keep agent/contributor policy concrete, scoped, and aligned
  with current Bot repo behavior.
